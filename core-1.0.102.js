...
THREE.OBJLoader.prototype = {
    ...
    load: function(e, t, r, i) {
        var a = this
          , s = new THREE.XHRLoader(a.manager);
        s.setPath(this.path),
        s.load(e, function(e) {
            t(a.parse(e))
        }, r, i)
    ...
    _createParserState: function() {
        var e = {
            ...
            addFace: function(e, t, r, i, a, s, n, o, p, l, h, c) {
                var u, d = this.vertices.length, f = this.parseVertexIndex(e, d), m = this.parseVertexIndex(t, d), y = this.parseVertexIndex(r, d);
                if (void 0 === i ? this.addVertex(f, m, y) : (u = this.parseVertexIndex(i, d),
                ...
                void 0 !== a) {
                    ...
                    void 0 === i ? this.addUV(f, m, y) : (u = this.parseUVIndex(o, g),
                    this.addUV(f, m, u),
                    this.addUV(m, y, u))
                }
                if (void 0 !== p) {
                    ...
                    void 0 === i ? this.addNormal(f, m, y) : (u = this.parseNormalIndex(c, v),
            ...
            addLineGeometry: function(e, t) {
                ...
                for (var r = this.vertices.length, i = this.uvs.length, a = 0, s = e.length; a < s; a++)
    ...
    parse: function(e) {
        ...
        -1 !== e.indexOf("\r\n") && (e = e.replace("\r\n", "\n"));
        for (var r = e.split("\n"), i = "", a = "", s = "", n = [], o = "function" == typeof "".trimLeft, p = 0, l = r.length; p < l; p++)
            if (i = r[p],
            0 !== (i = o ? i.trimLeft() : i.trim()).length && "#" !== (a = i.charAt(0)))
                if ("v" === a)
                    if (" " === (s = i.charAt(1)) && null !== (n = this.regexp.vertex_pattern.exec(i)))
                        t.vertices.push(parseFloat(n[1]), parseFloat(n[2]), parseFloat(n[3]));
                    else if ("n" === s && null !== (n = this.regexp.normal_pattern.exec(i)))
                        t.normals.push(parseFloat(n[1]), parseFloat(n[2]), parseFloat(n[3]));
                    else {
                        if ("t" !== s || null === (n = this.regexp.uv_pattern.exec(i)))
                            throw new Error("Unexpected vertex/normal/uv line: '" + i + "'");
                        t.uvs.push(parseFloat(n[1]), parseFloat(n[2]))
                    }
                else if ("f" === a)
                    if (null !== (n = this.regexp.face_vertex_uv_normal.exec(i)))
                        t.addFace(n[1], n[4], n[7], n[10], n[2], n[5], n[8], n[11], n[3], n[6], n[9], n[12]);
                    else if (null !== (n = this.regexp.face_vertex_uv.exec(i)))
                        t.addFace(n[1], n[3], n[5], n[7], n[2], n[4], n[6], n[8]);
                    else if (null !== (n = this.regexp.face_vertex_normal.exec(i)))
                        t.addFace(n[1], n[3], n[5], n[7], void 0, void 0, void 0, void 0, n[2], n[4], n[6], n[8]);
                    else {
                        if (null === (n = this.regexp.face_vertex.exec(i)))
                ...
                } else if (null !== (n = this.regexp.object_pattern.exec(i))) {
                    ...
                    if (null === (n = this.regexp.smoothing_pattern.exec(i))) {
                        if ("\0" === i)
                            continue;
                    ...
                    (R = t.object.currentMaterial()) && (R.smooth = t.object.smooth)
                }
        t.finalize();
        var v = new THREE.Group;
        v.materialLibraries = [].concat(t.materialLibraries);
        for (p = 0,
        l = t.objects.length; p < l; p++) {
            var b = t.objects[p]
              , x = b.geometry
              , P = b.materials
              , w = "Line" === x.type;
            if (0 !== x.vertices.length) {
                ...
                x.normals.length > 0 ? S.addAttribute("normal", new THREE.BufferAttribute(new Float32Array(x.normals),3)) : S.computeVertexNormals(),
                x.uvs.length > 0 && S.addAttribute("uv", new THREE.BufferAttribute(new Float32Array(x.uvs),2));
                for (var E, T = [], k = 0, O = P.length; k < O; k++) {
                    var Z = P[k]
                      , R = void 0;
                    if (null !== this.materials && (R = this.materials.create(Z.name),
                    w && R && !(R instanceof THREE.LineBasicMaterial))) {
                        var C = new THREE.LineBasicMaterial;
                        C.copy(R),
                        R = C
                    }
                    R || ((R = w ? new THREE.LineBasicMaterial : new THREE.MeshPhongMaterial).name = Z.name),
...
THREE.CopyShader = {
    ...
    vertexShader: ["uniform vec2 uvScale;", "uniform vec2 uvOffset;", "varying vec2 vUv;", "varying vec2 vUvScaled;", "void main() {", "vUv = uv;", "vUvScaled = uv * uvScale + uvOffset;", "gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );", "}"].join("\n"),
...
THREE.ShaderPass.prototype = {
    render: function(e, t, r, i) {
        r && (this.uniforms.tDiffuse.value = r.texture),
        e.render(this.scene, this.camera, t, i)
    }
},
...
THREE.MixPass = function() {
    THREE.ShaderPass.call(this, new THREE.ShaderMaterial({
        uniforms: {
            tDiffuse0: {
                type: "t",
                value: null
...
THREE.TTFLoader.prototype.parse = function(e) {
    if ("undefined" == typeof opentype)
        return console.warn("TTFLoader requires opentype.js Make sure it's included before using the loader"),
        null;
    function t(e) {
        var t, r = [];
        ...
        return r.forEach(function(e) {
            ...
            for (var r = e.length - 1; r > 0; r--) {
                ...
                void 0 !== a.x2 && void 0 !== a.y2 ? (t.x1 = a.x2,
                t.y1 = a.y2,
                t.x2 = a.x1,
                t.y2 = a.y1) : void 0 !== a.x1 && void 0 !== a.y1 && (t.x1 = a.x1,
                t.y1 = a.y1),
                t.x = e[r - 1].x,
                t.y = e[r - 1].y,
                i.push(t)
...
PZ.expression = class {
    ...
    parse(e) {
        let t = this.noop;
        try {
            let r, i = acorn.parse(e), a = ["frame", "time", "methods", "properties"], s = Object.keys(PZ.expression.methods), n = [], o = astring.baseGenerator.VariableDeclarator, p = (astring.baseGenerator.ArrowFunctionExpression,
            astring.baseGenerator.VariableDeclaration), l = Object.assign({}, astring.baseGenerator, {
                Program: function(e, t) {
                    for (var r = t.indent.repeat(t.indentLevel), i = t.lineEnd, a = e.body, s = a.length, n = 0; n < s; n++) {
                        var o = a[n];
                        t.write(r),
                        n === s - 1 && "ExpressionStatement" === o.type && t.write("return "),
                        this[o.type](o, t),
                        t.write(i)
                    }
                },
                ...
                VariableDeclarator: function(e, t) {
                    "Identifier" === e.id.type && n.push(e.id.name),
                    o.call(this, e, t)
                },
...
PZ.expression.methods = {
    ...
    shake(e, t=1, r=0, i=1, a=0, s=1) {
        let n = e * t + r
          ...
          , l = n - o;
        s && (l = l * l * (3 - 2 * l));
        let h = i * this.wave(o) + 2 * a * (this.random(o) - .5)
          , c = i * this.wave(p) + 2 * a * (this.random(p) - .5);
    ...
    gaussRandom(e, t=.5, r=.25) {
        for (var i = 0, a = 0; a < 5; a++)
            i += this.random(e * a);
...
function(e, t) {
    !function(e) {
        ...
        function I(e) {
            ...
            for (var r in U)
                t[r] = e && R(e, r) ? e[r] : U[r];
            if (t.ecmaVersion >= 2015 && (t.ecmaVersion -= 2009),
            ...
            return C(t.onComment) && (t.onComment = function(e, t) {
                return function(r, i, a, s, n, o) {
                    ...
                    e.locations && (p.loc = new L(this,n,o)),
                    e.ranges && (p.range = [a, s]),
                    t.push(p)
                }
            }(t, t.onComment)),
            t
        ...
        var G = function(e, r, a) {
            ...
            this.curLine = this.input.slice(0, this.lineStart).split(P).length) : (this.pos = this.lineStart = 0,
            this.curLine = 1),
            this.type = x.eof,
            this.value = null,
        ...
        W.isLet = function() {
            ...
            if (91 === r || 123 === r)
                return !0;
            if (u(r, !0)) {
                for (var i = t + 1; d(this.input.charCodeAt(i), !0); )
                    ++i;
        ...
        W.isAsyncFunction = function() {
            ...
            var e = T.exec(this.input)
              , t = this.pos + e[0].length;
            return !(P.test(this.input.slice(this.pos, t)) || "function" !== this.input.slice(t, t + 8) || t + 8 !== this.input.length && d(this.input.charAt(t + 8)))
        }
        ,
        W.parseStatement = function(e, t, r) {
            var i, a = this.type, s = this.startNode();
            switch (this.isLet() && (a = x._var,
            i = "let"),
            a) {
            case x._break:
            case x._continue:
            ...
            case x._function:
                return e && (this.strict || "if" !== e) && this.options.ecmaVersion >= 6 && this.unexpected(),
        ...
        W.parseBreakContinueStatement = function(e, t) {
            var r = "break" === t;
            this.next(),
            this.eat(x.semi) || this.insertSemicolon() ? e.label = null : this.type !== x.name ? this.unexpected() : (e.label = this.parseIdent(),
            this.semicolon());
        ...
        W.parseForStatement = function(e) {
            ...
            if (this.type === x._var || this.type === x._const || r) {
                ...
                !(this.type === x._in || this.options.ecmaVersion >= 6 && this.isContextual("of")) || 1 !== i.declarations.length || "var" !== a && i.declarations[0].init ? (t > -1 && this.unexpected(t),
                this.parseFor(e, i)) : (this.options.ecmaVersion >= 9 && (this.type === x._in ? t > -1 && this.unexpected(t) : e.await = t > -1),
                this.parseForIn(e, i))
            }
            var s = new q
              , n = this.parseExpression(!0, s);
            return this.type === x._in || this.options.ecmaVersion >= 6 && this.isContextual("of") ? (this.options.ecmaVersion >= 9 && (this.type === x._in ? t > -1 && this.unexpected(t) : e.await = t > -1),
            this.toAssignable(n, !1, s),
            this.checkLVal(n),
            this.parseForIn(e, n)) : (this.checkExpressionErrors(s, !0),
        ...
        W.parseFunctionStatement = function(e, t, r) {
            return this.next(),
            this.parseFunction(e, K | (r ? 0 : Q), !1, t)
        }
        ,
        ...
        W.parseReturnStatement = function(e) {
            ...
            this.next(),
            this.eat(x.semi) || this.insertSemicolon() ? e.argument = null : (e.argument = this.parseExpression(),
            this.semicolon()),
        ...
        W.parseSwitchStatement = function(e) {
            ...
            for (var r = !1; this.type !== x.braceR; )
                if (this.type === x._case || this.type === x._default) {
                    ...
                    t.consequent = [],
                    this.next(),
                    i ? t.test = this.parseExpression() : (r && this.raiseRecoverable(this.lastTokStart, "Multiple default clauses"),
                    r = !0,
                    t.test = null),
                    this.expect(x.colon)
                } else
        ...
        W.parseThrowStatement = function(e) {
            return this.next(),
            P.test(this.input.slice(this.lastTokEnd, this.start)) && this.raise(this.lastTokEnd, "Illegal newline after throw"),
        ...
        W.parseTryStatement = function(e) {
            ...
            return e.finalizer = this.eat(x._finally) ? this.parseBlock() : null,
        ...
        W.parseLabeledStatement = function(e, t, r, i) {
            ...
            for (var o = this.type.isLoop ? "loop" : this.type === x._switch ? "switch" : null, p = this.labels.length - 1; p >= 0; p--) {
                var l = this.labels[p];
            ...
            ("ClassDeclaration" === e.body.type || "VariableDeclaration" === e.body.type && "var" !== e.body.kind || "FunctionDeclaration" === e.body.type && (this.strict || e.body.generator || e.body.async)) && this.raiseRecoverable(e.body.start, "Invalid labeled declaration"),
            this.labels.pop(),
            e.label = r,
        ...
        W.parseBlock = function(e, t) {
            ...
            t.body = [],
            this.expect(x.braceL),
            e && this.enterScope(0); !this.eat(x.braceR); ) {
                var r = this.parseStatement(null);
                t.body.push(r)
            }
            return e && this.exitScope(),
        ...
        W.parseForIn = function(e, t) {
            ...
            return this.next(),
            "ForInStatement" === r && ("AssignmentPattern" === t.type || "VariableDeclaration" === t.type && null != t.declarations[0].init && (this.strict || "Identifier" !== t.declarations[0].id.type)) && this.raise(t.start, "Invalid assignment in for-in loop head"),
            e.left = t,
        ...
        W.parseVar = function(e, t, r) {
            ...
            e.kind = r; ; ) {
                var i = this.startNode();
                if (this.parseVarId(i, r),
                this.eat(x.eq) ? i.init = this.parseMaybeAssign(t) : "const" !== r || this.type === x._in || this.options.ecmaVersion >= 6 && this.isContextual("of") ? "Identifier" === i.id.type || t && (this.type === x._in || this.isContextual("of")) ? i.init = null : this.raise(this.lastTokEnd, "Complex binding patterns require an initialization value") : this.unexpected(),
        ...
        W.parseFunction = function(e, t, r, i) {
            this.initFunction(e),
            (this.options.ecmaVersion >= 9 || this.options.ecmaVersion >= 6 && !i) && (e.generator = this.eat(x.star)),
            this.options.ecmaVersion >= 8 && (e.async = !!i),
            t & K && (e.id = 4 & t && this.type !== x.name ? null : this.parseIdent(),
        ...
        W.parseFunctionParams = function(e) {
            this.expect(x.parenL),
            e.params = this.parseBindingList(x.parenR, !1, this.options.ecmaVersion >= 8),
        ...
        W.parseClass = function(e, t) {
            ...
            var r = this.startNode()
              , i = !1;
            for (r.body = [],
            this.expect(x.braceL); !this.eat(x.braceR); ) {
                var a = this.parseClassElement(null !== e.superClass);
                a && (r.body.push(a),
                "MethodDefinition" === a.type && "constructor" === a.kind && (i && this.raise(a.start, "Duplicate constructor in the same class"),
                i = !0))
            }
        ...
        W.parseClassElement = function(e) {
            ...
            var r = this.startNode()
              , i = function(e, i) {
                ...
                var a = t.start
                  , s = t.startLoc;
                return !!t.eatContextual(e) && (!(t.type === x.parenL || i && t.canInsertSemicolon()) || (r.key && t.unexpected(),
                r.computed = !1,
            ...
            var a = this.eat(x.star)
              , s = !1;
            a || (this.options.ecmaVersion >= 8 && i("async", !0) ? (s = !0,
            a = this.options.ecmaVersion >= 9 && this.eat(x.star)) : i("get") ? r.kind = "get" : i("set") && (r.kind = "set")),
            r.key || this.parsePropertyName(r);
            var n = r.key
              , o = !1;
            return r.computed || r.static || !("Identifier" === n.type && "constructor" === n.name || "Literal" === n.type && "constructor" === n.value) ? r.static && "Identifier" === n.type && "prototype" === n.name && this.raise(n.start, "Classes may not have a static property named prototype") : ("method" !== r.kind && this.raise(n.start, "Constructor can't have get/set modifier"),
        ...
        W.parseClassMethod = function(e, t, r, i) {
            return e.value = this.parseMethod(t, r, i),
        ...
        W.parseExport = function(e, t) {
            ...
            if (this.eat(x._default)) {
                ...
                this.type === x._function || (r = this.isAsyncFunction())) {
                    ...
                    this.next(),
                    r && this.next(),
                    e.declaration = this.parseFunction(i, 4 | K, !1, r, !0)
        ...
        W.checkExport = function(e, t, r) {
            e && (R(e, t) && this.raiseRecoverable(r, "Duplicate export '" + t + "'"),
            e[t] = !0)
        }
        ,
        ...
        W.parseImport = function(e) {
            return this.next(),
            this.type === x.string ? (e.specifiers = J,
        ...
        W.parseImportSpecifiers = function() {
            ...
            for (this.expect(x.braceL); !this.eat(x.braceR); ) {
                ...
                this.eatContextual("as") ? a.local = this.parseIdent() : (this.checkUnreserved(a.imported),
                a.local = a.imported),
        ...
        $.parseBindingAtom = function() {
            if (this.options.ecmaVersion >= 6)
                ...
                case x.bracketL:
                    var e = this.startNode();
                    return this.next(),
                    e.elements = this.parseBindingList(x.bracketR, !0, !0),
        ...
        $.checkLVal = function(e, t, r) {
            ...
            case "Identifier":
                ...
                r && (R(r, e.name) && this.raiseRecoverable(e.start, "Argument name clash"),
                r[e.name] = !0),
        ...
        ee.checkPropClash = function(e, t, r) {
            if (!(this.options.ecmaVersion >= 9 && "SpreadElement" === e.type || this.options.ecmaVersion >= 6 && (e.computed || e.method || e.shorthand))) {
                ...
                var s = e.kind;
                if (this.options.ecmaVersion >= 6)
                    "__proto__" === i && "init" === s && (t.proto && (r && r.doubleProto < 0 ? r.doubleProto = a.start : this.raiseRecoverable(a.start, "Redefinition of __proto__ property")),
                    t.proto = !0);
                else {
                    var n = t[i = "$" + i];
                    if (n)
                        ("init" === s ? this.strict && n.init || n.get || n.set : n.init || n[s]) && this.raiseRecoverable(a.start, "Redefinition of property");
                    else
                        n = t[i] = {
                            init: !1,
                            get: !1,
        ...
        ee.parseExpression = function(e, t) {
            ...
            if (this.type === x.comma) {
                ...
                for (s.expressions = [a]; this.eat(x.comma); )
        ...
        ee.parseMaybeAssign = function(e, t, r) {
            ...
            var i = !1
              ...
              , s = -1
              , n = -1;
            t ? (a = t.parenthesizedAssign,
            s = t.trailingComma,
            n = t.shorthandAssign,
            t.parenthesizedAssign = t.trailingComma = t.shorthandAssign = -1) : (t = new q,
            i = !0);
            var o = this.start
              , p = this.startLoc;
            this.type !== x.parenL && this.type !== x.name || (this.potentialArrowAt = this.start);
            var l = this.parseMaybeConditional(e, t);
            if (r && (l = r.call(this, l, o, p)),
            this.type.isAssign) {
        ...
        ee.parseMaybeUnary = function(e, t) {
            var r, i = this.start, a = this.startLoc;
        ...
        ee.parseExprSubscripts = function(e) {
            var t = this.start
              ...
              , a = "ArrowFunctionExpression" === i.type && ")" !== this.input.slice(this.lastTokStart, this.lastTokEnd);
            if (this.checkExpressionErrors(e) || a)
                return i;
        ...
        ee.parseSubscripts = function(e, t, r, i) {
            for (var a = this.options.ecmaVersion >= 8 && "Identifier" === e.type && "async" === e.name && this.lastTokEnd === e.end && !this.canInsertSemicolon() && "async" === this.input.slice(e.start, e.end), s = void 0; ; )
                if ((s = this.eat(x.bracketL)) || this.eat(x.dot)) {
                    ...
                    n.object = e,
                    n.property = s ? this.parseExpression() : this.parseIdent(!0),
                    n.computed = !!s,
                    ...
                    if (a && !this.canInsertSemicolon() && this.eat(x.arrow))
                        return this.checkPatternErrors(o, !1),
                        this.checkYieldAwaitInDefaultParams(),
                        this.yieldPos = p,
                        this.awaitPos = l,
                        this.parseArrowExpression(this.startNodeAt(t, r), h, !0);
                    ...
                    if (this.type !== x.backQuote)
                        return e;
                    var u = this.startNodeAt(t, r);
                    u.tag = e,
                    u.quasi = this.parseTemplate({
                        isTagged: !0
                    }),
        ...
        ee.parseExprAtom = function(e) {
            ...
            case x._super:
                ...
                t = this.startNode(),
                this.next(),
                this.type !== x.parenL || this.allowDirectSuper || this.raise(t.start, "super() call outside constructor of a subclass"),
            ...
            case x.name:
                ...
                if (this.options.ecmaVersion >= 8 && !s && "async" === n.name && !this.canInsertSemicolon() && this.eat(x._function))
                    return this.parseFunction(this.startNodeAt(i, a), 0, !1, !0);
                if (r && !this.canInsertSemicolon()) {
                    if (this.eat(x.arrow))
                        return this.parseArrowExpression(this.startNodeAt(i, a), [n], !1);
                    if (this.options.ecmaVersion >= 8 && "async" === n.name && this.type === x.name && !s)
                        ...
                        this.parseArrowExpression(this.startNodeAt(i, a), [n], !0)
                }
                return n;
            case x.regexp:
                var o = this.value;
            ...
            case x._true:
            case x._false:
                return (t = this.startNode()).value = this.type === x._null ? null : this.type === x._true,
            ...
            case x.parenL:
                ...
                return e && (e.parenthesizedAssign < 0 && !this.isSimpleAssignTarget(l) && (e.parenthesizedAssign = p),
                e.parenthesizedBind < 0 && (e.parenthesizedBind = p)),
                l;
            case x.bracketL:
                return t = this.startNode(),
                this.next(),
                t.elements = this.parseExprList(x.bracketR, !0, !0, e),
        ...
        ee.parseParenAndDistinguishExpression = function(e) {
            var t, r = this.start, i = this.startLoc, a = this.options.ecmaVersion >= 8;
            if (this.options.ecmaVersion >= 6) {
                this.next();
                var s, n = this.start, o = this.startLoc, p = [], l = !0, h = !1, c = new q, u = this.yieldPos, d = this.awaitPos;
                for (this.yieldPos = 0,
                this.awaitPos = 0; this.type !== x.parenR; ) {
                    if (l ? l = !1 : this.expect(x.comma),
                    a && this.afterTrailingComma(x.parenR, !0)) {
                        h = !0;
                        break
                    }
                    if (this.type === x.ellipsis) {
                ...
                e && !this.canInsertSemicolon() && this.eat(x.arrow))
                ...
                p.length > 1 ? ((t = this.startNodeAt(n, o)).expressions = p,
                this.finishNodeAt(t, "SequenceExpression", f, m)) : t = p[0]
            } else
        ...
        ee.parseNew = function() {
            ...
            var i = this.start
              , a = this.startLoc;
            return e.callee = this.parseSubscripts(this.parseExprAtom(), i, a, !0),
        ...
        ee.parseTemplateElement = function(e) {
            var t = e.isTagged
              , r = this.startNode();
            return this.type === x.invalidTemplate ? (t || this.raiseRecoverable(this.start, "Bad escape sequence in untagged template literal"),
            r.value = {
                raw: this.value,
                cooked: null
            }) : r.value = {
        ...
        ee.parseTemplate = function(e) {
            ...
            for (r.quasis = [i]; !i.tail; )
                ...
                r.quasis.push(i = this.parseTemplateElement({
                    isTagged: t
                }));
            return this.next(),
        ...
        ee.parseProperty = function(e, t) {
            var r, i, a, s, n = this.startNode();
            if (this.options.ecmaVersion >= 9 && this.eat(x.ellipsis))
                return e ? (n.argument = this.parseIdent(!1),
                this.type === x.comma && this.raise(this.start, "Comma is not permitted after the rest element"),
                this.finishNode(n, "RestElement")) : (this.type === x.parenL && t && (t.parenthesizedAssign < 0 && (t.parenthesizedAssign = this.start),
            ...
            this.options.ecmaVersion >= 6 && (n.method = !1,
            n.shorthand = !1,
            (e || t) && (a = this.start,
            s = this.startLoc),
            e || (r = this.eat(x.star)));
            var o = this.containsEsc;
            return this.parsePropertyName(n),
            !e && !o && this.options.ecmaVersion >= 8 && !r && this.isAsyncProp(n) ? (i = !0,
            r = this.options.ecmaVersion >= 9 && this.eat(x.star),
            this.parsePropertyName(n, t)) : i = !1,
            this.parsePropertyValue(n, e, r, i, a, s, t, o),
            this.finishNode(n, "Property")
        }
        ,
        ee.parsePropertyValue = function(e, t, r, i, a, s, n, o) {
            if ((r || i) && this.type === x.colon && this.unexpected(),
            this.eat(x.colon))
                e.value = t ? this.parseMaybeDefault(this.start, this.startLoc) : this.parseMaybeAssign(!1, n),
                e.kind = "init";
                ...
                this.options.ecmaVersion >= 6 && !e.computed && "Identifier" === e.key.type ? (this.checkUnreserved(e.key),
                e.kind = "init",
                t ? e.value = this.parseMaybeDefault(a, s, e.key) : this.type === x.eq && n ? (n.shorthandAssign < 0 && (n.shorthandAssign = this.start),
                e.value = this.parseMaybeDefault(a, s, e.key)) : e.value = e.key,
        ...
        ee.parseArrowExpression = function(e, t, r) {
            var i = this.yieldPos
              , a = this.awaitPos;
            return this.enterScope(16 | _(r, !1)),
            this.initFunction(e),
        ...
        ee.parseExprList = function(e, t, r, i) {
            for (var a = [], s = !0; !this.eat(e); ) {
                ...
                t && this.afterTrailingComma(e))
                    break;
                var n = void 0;
                r && this.type === x.comma ? n = null : this.type === x.ellipsis ? (n = this.parseSpread(i),
                i && this.type === x.comma && i.trailingComma < 0 && (i.trailingComma = this.start)) : n = this.parseMaybeAssign(!1, i),
                a.push(n)
            }
            return a
        }
        ...
        ee.checkUnreserved = function(e) {
            var t = e.start
              , r = e.end
              , i = e.name;
            if (this.inGenerator && "yield" === i && this.raiseRecoverable(t, "Can not use 'yield' as identifier inside a generator"),
            this.inAsync && "await" === i && this.raiseRecoverable(t, "Can not use 'await' as identifier inside an async function"),
            ...
            !(this.options.ecmaVersion < 6 && -1 !== this.input.slice(t, r).indexOf("\\"))) {
                ...
                a.test(i) && (this.inAsync || "await" !== i || this.raiseRecoverable(t, "Can not use keyword 'await' outside an async function"),
        ...
        ee.parseIdent = function(e, t) {
            ...
            this.type === x.name ? r.name = this.value : this.type.keyword ? (r.name = this.type.keyword,
        ...
        ie.enterScope = function(e) {
            this.scopeStack.push(new function(e) {
                this.flags = e,
                this.var = [],
                this.lexical = []
            }
        ...
        ie.declareName = function(e, t, r) {
            ...
            if (2 === t) {
                ...
                for (var o = this.scopeStack.length - 1; o >= 0; --o) {
                    ...
                    if (p.lexical.indexOf(e) > -1 && !(32 & p.flags) && p.lexical[0] === e && (i = !0),
                    p.var.push(e),
                    p.flags & A)
                        break
                }
        ...
        le.braceIsBlock = function(e) {
            ...
            return t === pe.f_expr || t === pe.f_stat || (e !== x.colon || t !== pe.b_stat && t !== pe.b_expr ? e === x._return || e === x.name && this.exprAllowed ? P.test(this.input.slice(this.lastTokEnd, this.start)) : e === x._else || e === x.semi || e === x.eof || e === x.parenR || e === x.arrow || (e === x.braceL ? t === pe.b_stat : e !== x._var && e !== x._const && e !== x.name && !this.exprAllowed) : !t.isExpr)
        }
        ,
        ...
        x._function.updateContext = x._class.updateContext = function(e) {
            !e.beforeExpr || e === x.semi || e === x._else || e === x._return && P.test(this.input.slice(this.lastTokEnd, this.start)) || (e === x.colon || e === x.braceL) && this.curContext() === pe.b_stat ? this.context.push(pe.f_stat) : this.context.push(pe.f_expr),
            this.exprAllowed = !1
        }
        ,
        ...
        x.name.updateContext = function(e) {
            var t = !1;
            this.options.ecmaVersion >= 6 && e !== x.dot && ("of" === this.value && !this.exprAllowed || "yield" === this.value && this.inGeneratorContext()) && (t = !0),
            this.exprAllowed = t
        }
        ;
        var he = {
        ...
        ue.prototype.at = function(e) {
            ...
            return !this.switchU || i <= 55295 || i >= 57344 || e + 1 >= r ? i : (i << 10) + t.charCodeAt(e + 1) - 56613888
        }
        ,
        ...
        ue.prototype.eat = function(e) {
            return this.current() === e && (this.advance(),
            !0)
        }
        ,
        ...
        ce.regexp_eatAssertion = function(e) {
            ...
            if (e.eat(40) && e.eat(63)) {
                var r = !1;
                if (this.options.ecmaVersion >= 9 && (r = e.eat(60)),
                e.eat(61) || e.eat(33))
        ...
        ce.regexp_eatBracedQuantifier = function(e, t) {
            ...
            if (e.eat(123)) {
                ...
                e.eat(125)))
                    return -1 !== a && a < i && !t && e.raise("numbers out of order in {} quantifier"),
                    !0;
        ...
        ce.regexp_eatSyntaxCharacter = function(e) {
            var t = e.current();
            return !!fe(t) && (e.lastIntValue = t,
            e.advance(),
            !0)
        }
        ,
        ce.regexp_eatPatternCharacters = function(e) {
            for (var t = e.pos, r = 0; -1 !== (r = e.current()) && !fe(r); )
                e.advance();
            return e.pos !== t
        }
        ,
        ...
        ce.regexp_eatZero = function(e) {
            return 48 === e.current() && !ve(e.lookahead()) && (e.lastIntValue = 0,
            e.advance(),
            !0)
        }
        ,
        ...
        ce.regexp_eatControlLetter = function(e) {
            var t = e.current();
            return !!me(t) && (e.lastIntValue = t % 32,
            e.advance(),
            !0)
        }
        ,
        ce.regexp_eatRegExpUnicodeEscapeSequence = function(e) {
            ...
            if (e.eat(117)) {
                if (this.regexp_eatFixedHexDigits(e, 4)) {
                    ...
                    if (e.switchU && i >= 55296 && i <= 56319) {
                        ...
                        if (e.eat(92) && e.eat(117) && this.regexp_eatFixedHexDigits(e, 4)) {
                            ...
                            if (s >= 56320 && s <= 57343)
                                return e.lastIntValue = 1024 * (i - 55296) + (s - 56320) + 65536,
                                !0
                        }
                        e.pos = a,
                        e.lastIntValue = i
                ...
                if (e.switchU && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) && ((t = e.lastIntValue) >= 0 && t <= 1114111))
                    return !0;
                e.switchU && e.raise("Invalid unicode escape"),
                e.pos = r
            }
            return !1
        }
        ...
        ce.regexp_eatUnicodePropertyName = function(e) {
            var t = 0;
            for (e.lastStringValue = ""; ye(t = e.current()); )
                e.lastStringValue += de(t),
                e.advance();
        ...
        ce.regexp_eatUnicodePropertyValue = function(e) {
            var t = 0;
            for (e.lastStringValue = ""; ge(t = e.current()); )
                e.lastStringValue += de(t),
                e.advance();
            return "" !== e.lastStringValue
        }
        ...
        ce.regexp_eatClassAtom = function(e) {
            ...
            if (e.eat(92)) {
                ...
                if (e.switchU) {
                    var r = e.current();
                    (99 === r || Pe(r)) && e.raise("Invalid class escape"),
                    e.raise("Invalid escape")
                }
                e.pos = t
            }
        ...
        ce.regexp_eatClassControlLetter = function(e) {
            var t = e.current();
            return !(!ve(t) && 95 !== t) && (e.lastIntValue = t % 32,
            e.advance(),
            !0)
        }
        ,
        ...
        ce.regexp_eatHexDigits = function(e) {
            ...
            for (e.lastIntValue = 0; be(r = e.current()); )
                e.lastIntValue = 16 * e.lastIntValue + xe(r),
                e.advance();
            return e.pos !== t
        }
        ,
        ...
        ce.regexp_eatOctalDigit = function(e) {
            var t = e.current();
            return Pe(t) ? (e.lastIntValue = t - 48,
            e.advance(),
            !0) : (e.lastIntValue = 0,
            !1)
        }
        ...
        ce.regexp_eatFixedHexDigits = function(e, t) {
            ...
            for (var i = 0; i < t; ++i) {
                ...
                if (!be(a))
                    return e.pos = r,
                    !1;
                e.lastIntValue = 16 * e.lastIntValue + xe(a),
                e.advance()
            }
            return !0
        }
        ...
        Se.nextToken = function() {
            ...
            this.pos >= this.input.length ? this.finishToken(x.eof) : e.override ? e.override(this) : void this.readToken(this.fullCharCodeAtPos())
        }
        ,
        ...
        Se.skipBlockComment = function() {
            var e, t = this.options.onComment && this.curPosition(), r = this.pos, i = this.input.indexOf("*/", this.pos += 2);
        ...
        Se.skipLineComment = function(e) {
            for (var t = this.pos, r = this.options.onComment && this.curPosition(), i = this.input.charCodeAt(this.pos += e); this.pos < this.input.length && !S(i); )
        ...
        Se.skipSpace = function() {
            e: for (; this.pos < this.input.length; ) {
                ...
                case 47:
                    ...
                    break;
                default:
                    if (!(e > 8 && e < 14 || e >= 5760 && E.test(String.fromCharCode(e))))
                        break e;
                    ++this.pos
                }
            }
        ...
        Se.readToken_slash = function() {
            ...
            this.readRegexp()) : 61 === e ? this.finishOp(x.assign, 2) : this.finishOp(x.slash, 1)
        }
        ,
        Se.readToken_mult_modulo_exp = function(e) {
            ...
            return this.options.ecmaVersion >= 7 && 42 === e && 42 === t && (++r,
            i = x.starstar,
        ...
        Se.readToken_plus_min = function(e) {
            var t = this.input.charCodeAt(this.pos + 1);
            return t === e ? 45 !== t || this.inModule || 62 !== this.input.charCodeAt(this.pos + 2) || 0 !== this.lastTokEnd && !P.test(this.input.slice(this.lastTokEnd, this.pos)) ? this.finishOp(x.incDec, 2) : (this.skipLineComment(3),
            this.skipSpace(),
            this.nextToken()) : 61 === t ? this.finishOp(x.assign, 2) : this.finishOp(x.plusMin, 1)
        }
        ,
        Se.readToken_lt_gt = function(e) {
            ...
            61 === this.input.charCodeAt(this.pos + r) ? this.finishOp(x.assign, r + 1) : this.finishOp(x.bitShift, r)) : 33 !== t || 60 !== e || this.inModule || 45 !== this.input.charCodeAt(this.pos + 2) || 45 !== this.input.charCodeAt(this.pos + 3) ? (61 === t && (r = 2),
            this.finishOp(x.relational, r)) : (this.skipLineComment(4),
            this.skipSpace(),
            this.nextToken())
        }
        ,
        Se.readToken_eq_excl = function(e) {
            var t = this.input.charCodeAt(this.pos + 1);
            return 61 === t ? this.finishOp(x.equality, 61 === this.input.charCodeAt(this.pos + 2) ? 3 : 2) : 61 === e && 62 === t && this.options.ecmaVersion >= 6 ? (this.pos += 2,
            this.finishToken(x.arrow)) : this.finishOp(61 === e ? x.eq : x.prefix, 1)
        }
        ,
        ...
        Se.readRegexp = function() {
            for (var e, t, r = this.pos; ; ) {
                ...
                if (P.test(i) && this.raise(r, "Unterminated regular expression"),
                e)
                    e = !1;
                else {
                    if ("[" === i)
        ...
        Se.readNumber = function(e) {
            ...
            this.readInt(10),
            i = this.input.charCodeAt(this.pos)),
            69 !== i && 101 !== i || r || (43 !== (i = this.input.charCodeAt(++this.pos)) && 45 !== i || ++this.pos,
        ...
        Se.readString = function(e) {
            for (var t = "", r = ++this.pos; ; ) {
                ...
                if (i === e)
                    break;
                92 === i ? (t += this.input.slice(r, this.pos),
                t += this.readEscapedChar(!1),
                r = this.pos) : (S(i, this.options.ecmaVersion >= 10) && this.raise(this.start, "Unterminated string constant"),
                ++this.pos)
            }
        ...
        Se.readTmplToken = function() {
            for (var e = "", t = this.pos; ; ) {
                ...
                if (96 === r || 36 === r && 123 === this.input.charCodeAt(this.pos + 1))
                    return this.pos !== this.start || this.type !== x.template && this.type !== x.invalidTemplate ? (e += this.input.slice(t, this.pos),
                    this.finishToken(x.template, e)) : 36 === r ? (this.pos += 2,
        ...
        Se.readHexChar = function(e) {
            var t = this.pos
              , r = this.readInt(16, e);
            return null === r && this.invalidStringToken(t, "Bad character escape sequence"),
            r
        }
        ,
        ...
        Se.readWord = function() {
            var e = this.readWord1()
              , t = x.name;
            return this.keywords.test(e) && (this.containsEsc && this.raiseRecoverable(this.start, "Escape sequence in keyword " + e),
            t = v[e]),
    ...
    !function(e) {
        ...
        function n(e, t, s, n) {
            ...
            !function(e, t, s) {
                ...
                if (13 !== n && 14 !== n)
                    return !1;
                if ("**" === e.operator && "**" === t.operator)
                    return !s;
                if (s)
                    return r[e.operator] <= r[t.operator];
                return r[e.operator] < r[t.operator]
            }(t, s, n) ? o[t.type](t, e) : (e.write("("),
            o[t.type](t, e),
            e.write(")"))
        }
        function o(e, t, r, i) {
        ...
        function p(e, t, r, i) {
            for (var a = t.length, s = 0; s < a; s++) {
                var n = t[s];
                e.write(r),
                "L" === n.type[0] ? e.write("// " + n.value.trim() + "\n") : (e.write("/*"),
                o(e, n.value, r, i),
                e.write("*/" + i))
            }
        }
        ...
        var h = void 0
          ...
          , y = e.baseGenerator = {
            ...
            BlockStatement: m = function(e, t) {
                ...
                if (null != n && n.length > 0) {
                    t.write(i),
                    a && null != e.comments && p(t, e.comments, s, i);
            ...
            ExpressionStatement: function(e, t) {
                ...
                r === i || 3 === r && "O" === e.expression.left.type[0] ? (t.write("("),
            ...
            ClassDeclaration: function(e, t) {
                ...
                e.superClass && (t.write("extends "),
                this[e.superClass.type](e.superClass, t),
                t.write(" ")),
            ...
            ArrowFunctionExpression: function(e, t) {
                ...
                var r = e.params;
                null != r && (1 === r.length && "I" === r[0].type[0] ? t.write(r[0].name, r[0]) : s(t, e.params)),
                t.write(" => "),
                "O" === e.body.type[0] ? (t.write("("),
            ...
            AwaitExpression: function(e, t) {
                t.write("await "),
                e.argument && this[e.argument.type](e.argument, t)
            },
            TemplateLiteral: function(e, t) {
                ...
                for (var a = i.length, s = 0; s < a; s++) {
                    var n = i[s];
                    t.write(r[s].value.raw),
                    t.write("${"),
                    this[n.type](n, t),
                    t.write("}")
                }
                t.write(r[r.length - 1].value.raw),
                t.write("`")
            },
            TaggedTemplateExpression: function(e, t) {
                this[e.tag.type](e.tag, t),
            ...
            ObjectExpression: function(e, t) {
                ...
                e.properties.length > 0) {
                    ...
                    for (var n = "," + i, o = e.properties, l = o.length, h = 0; ; ) {
                        var c = o[h];
                        if (a && null != c.comments && p(t, c.comments, s, i),
                        t.write(s),
                        this.Property(c, t),
                        !(++h < l))
                            break;
                    ...
                    t.write(r + "}")) : null != e.trailingComments ? (t.write(i),
                    p(t, e.trailingComments, s, i),
                    t.write(r + "}")) : t.write("}") : t.write("}");
                t.indentLevel--
            },
            Property: function(e, t) {
                e.method || "i" !== e.kind[0] ? this.MethodDefinition(e, t) : (e.shorthand || (e.computed ? (t.write("["),
                this[e.key.type](e.key, t),
                t.write("]")) : this[e.key.type](e.key, t),
                t.write(": ")),
            ...
            ObjectPattern: function(e, t) {
                if (t.write("{"),
                e.properties.length > 0)
                    for (var r = e.properties, i = r.length, a = 0; this[r[a].type](r[a], t),
                    ++a < i; )
                        t.write(", ");
                t.write("}")
            },
            ...
            UnaryExpression: function(e, t) {
                ...
                a[e.argument.type] < a.UnaryExpression ? (t.write("("),
                this[e.argument.type](e.argument, t),
                t.write(")")) : this[e.argument.type](e.argument, t)) : (this[e.argument.type](e.argument, t),
                t.write(e.operator))
            },
            ...
            BinaryExpression: d = function(e, t) {
                "in" === e.operator ? (t.write("("),
                n(t, e.left, e, !1),
                t.write(" " + e.operator + " "),
                n(t, e.right, e, !0),
                t.write(")")) : (n(t, e.left, e, !1),
                t.write(" " + e.operator + " "),
                n(t, e.right, e, !0))
            }
            ,
            ...
            ConditionalExpression: function(e, t) {
                a[e.test.type] > a.ConditionalExpression ? this[e.test.type](e.test, t) : (t.write("("),
                this[e.test.type](e.test, t),
                t.write(")")),
                t.write(" ? "),
                this[e.consequent.type](e.consequent, t),
            ...
            NewExpression: function(e, t) {
                t.write("new "),
                a[e.callee.type] < a.CallExpression || function(e) {
                    var t = e;
                    for (; null != t; ) {
                        var r = t
                          , i = r.type;
            ...
            CallExpression: function(e, t) {
                a[e.callee.type] < a.CallExpression ? (t.write("("),
                this[e.callee.type](e.callee, t),
                t.write(")")) : this[e.callee.type](e.callee, t),
                s(t, e.arguments)
            },
            MemberExpression: function(e, t) {
                a[e.object.type] < a.MemberExpression ? (t.write("("),
                this[e.object.type](e.object, t),
            ...
            Literal: function(e, r) {
                null != e.raw ? r.write(e.raw, e) : null != e.regex ? this.RegExpLiteral(e, r) : r.write(t(e.value), e)
            },
          ...
          , v = function() {
            function e(t) {
                ...
                var r = null == t ? g : t;
                this.output = "",
                null != r.output ? (this.output = r.output,
                ...
                null != r.sourceMap && (this.write = null == r.output ? this.writeAndMap : this.writeToStreamAndMap,
            ...
            e.prototype.map = function(e, t) {
                if (null != t && null != t.loc) {
                    var r = this.mapping;
                    r.original = t.loc.start,
                    r.name = t.name,
                    this.sourceMap.addMapping(r)
                }
                e.length > 0 && (this.lineEndSize > 0 && e.endsWith(this.lineEnd) ? (this.line += this.lineEndSize,
                this.column = 0) : "\n" === e[e.length - 1] ? (this.line++,
                this.column = 0) : this.column += e.length)
            }
            ,
...
PZ.object = class {
    static getType(e) {
        if ("string" == typeof e && PZ[e] && PZ[e].prototype instanceof PZ.object)
            return PZ[e]
    }
    ...
    getAddress(e) {
        ...
        return e && t.push(this.children.indexOf(e)),
        t
    }
    addressLookup(e, t) {
        let r = e[t = t || 0];
    ...
    forEachItemOfType(e, t) {
        if (this instanceof e && t(this),
        this.children)
            for (let r = 0; r < this.children.length; r++)
                this.children[r].forEachItemOfType(e, t)
    }
    getParentOfType(e) {
        return this.parentObject instanceof e ? this.parentObject : this.parentObject.getParentOfType(e)
    }
    tryGetParentOfType(e) {
        return this.parent ? this.parentObject instanceof e ? this.parentObject : this.parentObject.tryGetParentOfType(e) : null
    }
    get parentProject() {
...
PZ.objectList = class extends Array {
    ...
    splice() {
        ...
        for (let t = 0; t < e.length; t++)
            null !== this.parent && (e[t].parent = null),
            this.onObjectRemoved.update(e[t], arguments[0]);
        ...
        return this.onListChanged.update(),
        e
    }
    push() {
    ...
    getAddress(e) {
        ...
        return e && t.push(this.indexOf(e)),
        t
    }
    addressLookup(e, t) {
        let r = e[t = t || 0];
...
PZ.keyframe = class extends PZ.object {
    ...
    load(e) {
        ...
        this.frame = e.frame,
        this.tween = e.tween,
        void 0 !== e.controlPoints && (this.controlPoints[0][0] = e.controlPoints[0][0],
    ...
    toJSON() {
        ...
        return this.continuousTangent || (e.continuousTangent = this.continuousTangent),
        e
    }
}
,
PZ.propertyList = class {
    constructor(e, t) {
        Object.defineProperties(this, {
            ...
            childListChanged_bound: {
                value: this.childListChanged.bind(this)
            },
            parent: {
                set(e) {
    ...
    removeAll(e) {
        ...
        for (let e = 0; e < t.length; e++) {
            let r = this[t[e]];
            delete this[t[e]],
            r instanceof PZ.propertyList && r.onListChanged.unwatch(this.childListChanged_bound)
        }
        this.onListChanged.update()
    }
    *[Symbol.iterator]() {
    ...
    forEachItemOfType(e, t) {
        this instanceof e && t(this);
        for (let r of this)
            r.forEachItemOfType(e, t)
    }
    getAddress(e) {
        let t = this.parent.getAddress(this);
        return e && t.push(this.findKey(e)),
        t
    }
    addressLookup(e, t) {
        let r = e[t];
...
PZ.property = class extends PZ.object {
    static create(e) {
        ...
        if (e.custom && e.dynamic && e.type > 0 && !e.objects) {
            ...
            e.group = !0,
            e.objects = [],
            e.type === PZ.property.type.COLOR ? (t = 3,
            i = 1,
            r = ["R", "G", "B"]) : (t = e.type + 1,
            i = 1,
            r = ["X", "Y", "Z", "W"]);
            for (let a = 0; a < t; a++) {
                ...
                e.type === PZ.property.type.COLOR && (t.min = 0,
                t.max = 1),
                e.objects.push(t)
            }
        }
        return t = e.dynamic ? e.group ? new PZ.property.dynamic.group(e) : new PZ.property.dynamic.keyframes(e) : new PZ.property.static(e)
    }
    constructor(e) {
        super(),
        this.definition = e,
        this.type = e,
        e.name || (this.properties = new PZ.propertyList(null,this),
    ...
    toJSON() {
        let e = {};
        return this.type.custom && (e.type = this.type),
...
PZ.property.static = class extends PZ.property {
    ...
    toJSON() {
        let e = super.toJSON();
        return Object.keys(e).length ? e.value = this.value : e = this.value,
        e
    }
    load(e) {
        if (super.load(e),
        e instanceof PZ.property)
            e = e.value;
        else if ("object" == typeof e)
            e = e && e.value ? e.value : JSON.parse(JSON.stringify(e));
        else if (void 0 === e && "function" == typeof (e = this.getDefaultValue()))
            return void e(this);
        this.set(e)
    }
    get() {
...
PZ.property.dynamic = class extends PZ.property {
    ...
    toJSON() {
        let e = super.toJSON();
        return this.expression && (e.expression = this.expression),
        e
    }
    load(e) {
        super.load(e),
        e && ("string" == typeof e.expression ? this.expression = new PZ.expression(e.expression) : e.expression instanceof PZ.expression && (this.expression = new PZ.expression(e.expression.source)))
    }
    get(e) {
        if (null !== this.expression)
            return this.expression.evaluate(e, this.parentObject)
    }
}
,
PZ.property.dynamic.staticBehavior = {
    CONSTANT: 0,
    LINEAR: 1
},
PZ.property.dynamic.group = class extends PZ.property.dynamic {
    constructor(e) {
        ...
        for (let r = 0; r < e.objects.length; r++)
            this.objects.push(PZ.property.create(e.objects[r])),
            this.objects[r].onAnimatedChanged.watch(t);
    ...
    toJSON() {
        let e = super.toJSON();
        return e.objects = this.objects,
        e
    }
    load(e) {
        if (super.load(e),
        e) {
            if (e.objects = e.objects || new Array(this.objects.length).fill(null).map(e=>new Object),
            void 0 !== e.keyframes)
            ...
            if (void 0 !== e.animated)
                for (let t = 0; t < e.objects.length; t++)
                    e.objects[t].animated = e.animated;
            for (let t = 0; t < this.objects.length; t++)
                this.objects[t].load(e.objects[t])
        } else
    ...
    get(e) {
        if (null !== this.expression)
            return this.expression.evaluate(e, this.parentObject);
        for (let t = 0; t < this.objects.length; t++)
            this.value[t] = this.objects[t].get(e);
        return this.value
    }
    set(e, t) {
        for (let r = 0; r < this.objects.length; r++)
            this.objects[r].set(e[r], t)
    }
    hasKeyframe(e) {
...
PZ.property.dynamic.keyframes = class extends PZ.property.dynamic {
    ...
    set animated(e) {
        e !== this._animated && (this._animated = e,
        this.onAnimatedChanged.update(!e))
    }
    get frameOffset() {
        let e = this.tryGetParentOfType(PZ.clip);
        return e ? e.start : 0
    ...
    toJSON() {
        let e = super.toJSON();
        return e.animated = this.animated,
        e.keyframes = this.keyframes,
        e
    }
    load(e) {
        if (super.load(e),
        e) {
            ...
            "function" == typeof e ? e(this) : this.definition.allowEmpty || this.keyframes.push(new PZ.keyframe(e,0,this.defaultTween))
        }
    }
    get(e) {
        if (null !== this.expression)
            return this.expression.evaluate(e, this.parentObject);
        let t, r = this.getClosestKeyframeIndex(e), i = this.keyframes[r];
        if (i.frame > e && r > 0)
            t = i,
            i = this.keyframes[--r];
        else {
        ...
        if (!t || null === PZ.tween.easingList[255 & t.tween].fn)
            return i.value;
        let a = Math.max((e - i.frame) / (t.frame - i.frame), 0)
          , s = PZ.tween.easingList[255 & t.tween].fn(a);
        if (t.tween >> 8 == 1) {
            let r, a = PZ.property.dynamic.keyframes.o, s = PZ.tween.correctCurve(i, t);
            return r = PZ.tween.findZero(e, i.frame, i.controlPoints[1][0] * s + i.frame, t.controlPoints[0][0] * s + t.frame, t.frame, a) ? PZ.tween.bezier(i.value, i.controlPoints[1][1] * s + i.value, t.controlPoints[0][1] * s + t.value, t.value, a[0]) : i.value
        }
    ...
    getClosestKeyframeIndex(e, t, r) {
        for (t |= 0,
        r = void 0 === r ? this.keyframes.length - 1 : 0; ; ) {
            if (r <= t)
                return r;
            let i = t + (r - t >> 1)
    ...
    getPreviousKeyframe(e) {
        let t = this.getClosestKeyframeIndex(e);
        return t < 0 ? null : (this.keyframes[t].frame >= e && this.keyframes[t - 1] && (t -= 1),
        this.keyframes[t])
    }
    getNextKeyframe(e) {
        let t = this.getClosestKeyframeIndex(e);
    ...
    addKeyframe(e) {
        ...
        return (r < 0 || this.keyframes[r].frame < t) && r++,
        this.keyframes.splice(r, 0, e),
        r
    }
    deleteKeyframeIdx(e) {
    ...
    deleteKeyframe(e) {
        let t = this.getKeyframeIndex(e);
        if (!(t < 0))
            return this.deleteKeyframeIdx(t)
    }
    shiftKeyframes(e) {
        for (let t = 0; t < this.keyframes.length; t++)
            this.keyframes[t].frame += e,
            this.onKeyframeMoved.update(null, this.keyframes[t])
    }
    scaleKeyframes(e) {
        for (let t = 0; t < this.keyframes.length; t++)
            this.keyframes[t].frame *= e,
...
PZ.observable.prototype.update = function(...e) {
    for (var t = 0; t < this.watchers.length; t++)
        this.watchers[t](...e)
}
,
...
PZ.random.color = function(e) {
    ...
    return e && t.push(this.number(0, 1)),
    t
}
,
...
PZ.tween.easing = {
    ...
    Bounce: {
        ...
        InOut: function(e) {
            return e < .5 ? .5 * PZ.tween.easing.Bounce.In(2 * e) : .5 * PZ.tween.easing.Bounce.Out(2 * e - 1) + .5
        }
    }
},
PZ.tween.easingList = [{
    ...
    name: "linear",
    fn: PZ.tween.easing.Linear.None
}, {
    name: "quadratic in",
    fn: PZ.tween.easing.Quadratic.In
}, {
    name: "quadratic out",
    fn: PZ.tween.easing.Quadratic.Out
}, {
    name: "quadratic in-out",
    fn: PZ.tween.easing.Quadratic.InOut
}, {
    name: "cubic in",
    fn: PZ.tween.easing.Cubic.In
}, {
    name: "cubic out",
    fn: PZ.tween.easing.Cubic.Out
}, {
    name: "cubic in-out",
    fn: PZ.tween.easing.Cubic.InOut
}, {
    name: "quartic in",
    fn: PZ.tween.easing.Quartic.In
}, {
    name: "quartic out",
    fn: PZ.tween.easing.Quartic.Out
}, {
    name: "quartic in-out",
    fn: PZ.tween.easing.Quartic.InOut
}, {
    name: "quintic in",
    fn: PZ.tween.easing.Quintic.In
}, {
    name: "quintic out",
    fn: PZ.tween.easing.Quintic.Out
}, {
    name: "quintic in-out",
    fn: PZ.tween.easing.Quintic.InOut
}, {
    name: "sinusoidal in",
    fn: PZ.tween.easing.Sinusoidal.In
}, {
    name: "sinusoidal out",
    fn: PZ.tween.easing.Sinusoidal.Out
}, {
    name: "sinusoidal in-out",
    fn: PZ.tween.easing.Sinusoidal.InOut
}, {
    name: "exponential in",
    fn: PZ.tween.easing.Exponential.In
}, {
    name: "exponential out",
    fn: PZ.tween.easing.Exponential.Out
}, {
    name: "exponential in-out",
    fn: PZ.tween.easing.Exponential.InOut
}, {
    name: "circular in",
    fn: PZ.tween.easing.Circular.In
}, {
    name: "circular out",
    fn: PZ.tween.easing.Circular.Out
}, {
    name: "circular in-out",
    fn: PZ.tween.easing.Circular.InOut
}, {
    name: "elastic in",
    fn: PZ.tween.easing.Elastic.In
}, {
    name: "elastic out",
    fn: PZ.tween.easing.Elastic.Out
}, {
    name: "elastic in-out",
    fn: PZ.tween.easing.Elastic.InOut
}, {
    name: "back in",
    fn: PZ.tween.easing.Back.In
}, {
    name: "back out",
    fn: PZ.tween.easing.Back.Out
}, {
    name: "back in-out",
    fn: PZ.tween.easing.Back.InOut
}, {
    name: "bounce in",
    fn: PZ.tween.easing.Bounce.In
}, {
    name: "bounce out",
    fn: PZ.tween.easing.Bounce.Out
}, {
    name: "bounce in-out",
    fn: PZ.tween.easing.Bounce.InOut
}, {
    name: "cubic out-in",
    fn: PZ.tween.easing.Cubic.OutIn
}],
...
PZ.tween.curve = function(e, t, r, i, a, s, n) {
    let o = .5 * r
      , p = .5 * s - 4 * a + 10 * i - 3 * o - 6 * t - 10 * e
      , l = a - 4 * i + p + 2 * o + 3 * t + 4 * e;
    return l * n * n * n * n * n + (s - 11 * i - 9 * l + 5 * p + 9 * o + 11 * t + 11 * e) * n * n * n * n + p * n * n * n + o * n * n + t * n + e
}
,
PZ.tween.bezier = function(e, t, r, i, a) {
    let s, n, o, p;
    return (s = e) + a * (n = 3 * (t - e)) + a * a * (o = 3 * (e - 2 * t + r)) + a * a * a * (p = i - e + 3 * (t - r))
}
,
PZ.tween.findZero = function(e, t, r, i, a, s) {
    let n, o, p, l, h, c, u, d, f, m, y, g, v = 0, b = e=>0 === e ? 0 : e < 0 ? -Math.exp(Math.log(-e) / 3) : Math.exp(Math.log(e) / 3);
    if (n = t - e,
    o = 3 * (r - t),
    p = 3 * (t - 2 * r + i),
    0 !== (l = a - t + 3 * (r - i)))
        return h = p / l,
        (m = (f = (2 * (h /= 3) * h * h - h * (c = o / l) + (u = n / l)) / 2) * f + (d = c / 3 - h * h) * d * d) > 0 ? (y = Math.sqrt(m),
        s[0] = b(-f + y) + b(-f - y) - h,
        s[0] >= -1e-10 && s[0] <= 1.000001 ? 1 : 0) : 0 === m ? (y = b(-f),
        s[0] = 2 * y - h,
        s[0] >= -1e-10 && s[0] <= 1.000001 && v++,
        s[v] = -y - h,
        s[v] >= -1e-10 && s[v] <= 1.000001 ? v + 1 : v) : (g = Math.acos(-f / Math.sqrt(-d * d * d)),
        y = Math.sqrt(-d),
        d = Math.cos(g / 3),
        f = Math.sqrt(3 - 3 * d * d),
        s[0] = 2 * y * d - h,
...
PZ.archive.prototype.untar = async function(e) {
    await this.callWorker(!0, ["-xvzf", "/blob/blob.pz", "-C", "/pz", "-s", "/pz//"], [{
        name: "blob.pz",
        data: e
    }])
}
    ...
    return new Promise(function(a, s) {
        ...
        i.worker.onmessage = function(s) {
            ...
            if ("ready" === n.type)
                ...
                var o;
                if (i.worker.terminate(),
                i.worker = null,
                !1 !== e)
                    i.files = n.data,
                    a();
                else
                    n.file ? o = n.file : n.data.length > 0 && (o = n.data[0].data) && (o = new Blob([o],{
...
PZ.archive.prototype.encodeString = function(e) {
    ...
    for (var t = [], r = 0; r < e.length; r++) {
        ...
        i < 128 ? t.push(i) : i < 2048 ? t.push(192 | i >> 6, 128 | 63 & i) : i < 55296 || i >= 57344 ? t.push(224 | i >> 12, 128 | i >> 6 & 63, 128 | 63 & i) : (r++,
...
PZ.archive.prototype.decodeString = function(e) {
    ...
    t = 0; t < r; )
        ...
        case 13:
            a = e[t++],
            String.fromCharCode((31 & i) << 6 | 63 & a);
            break;
        case 14:
            a = e[t++],
            s = e[t++],
...
PZ.av.decode = function(e, t) {
    ...
    r.onmessage = function(i) {
        ...
        if ("ready" === a.type) {
            ...
            var s, n;
            r.terminate(),
            a.data.length > 0 && (s = a.data[0].data,
            n = a.data[1].data),
            t(s, n)
        }
    }
...
PZ.av.encode = async function(e, t) {
    return new Promise(function(r, i) {
        ...
        0 === s.deadline ? n.deadline = 0 : 2 === s.deadline && (n.deadline = 1e6),
        console.log("Video: " + n.frameWidth + "x" + n.frameHeight + " " + n.frameRate + "fps " + n.videoBitrate + "b/s"),
        console.log("Encoder: cpu_used: " + n.cpu_used + " deadline: " + n.deadline + " lag_in_frames: " + n.lag_in_frames),
        PZ.av.timeTotal = performance.now();
        var o = n.frameWidth * n.frameHeight * 4;
        function p(e, t, r) {
            if (PZ.av.timeRendering += performance.now() - PZ.av.timerStart,
            e && (r = Math.min(PZ.av.audioBuffer.length - PZ.av.bufferStartSample, t.num)) > 0) {
                var i = [];
                PZ.av.hasThreads ? (i[0] = new Float32Array(PZ.av.sharedHeap,t.xfer_ptrs[0],r),
                i[1] = new Float32Array(PZ.av.sharedHeap,t.xfer_ptrs[1],r)) : (i[0] = new Float32Array(t.xfer_buffer,t.xfer_ptrs[0],r),
        ...
        PZ.av.worker.onmessage = async function(t) {
            ...
            if ("video" === a.type)
                ...
                if (PZ.av.timerStart = performance.now(),
                null === PZ.av.audioBuffer || PZ.av.bufferStartSample >= PZ.av.audioBuffer.length) {
                ...
                PZ.av.readOutput(a);
            else if ("write" === a.type)
                PZ.av.writeOutput(a);
            else if ("buffer" === a.type)
                PZ.av.sharedHeap = a.buffer;
            else if ("remux" === a.type) {
                var h;
                a.data.length > 0 && (h = a.data[0].data),
                PZ.av.remuxCallback(h, a.offset)
            } else if ("ready" === a.type)
                ...
                PZ.av.stop(),
                a.file ? (c = a.file,
                console.log("Output size: " + c.size / 1024 / 1024 + " MB")) : a.data.length > 0 && (c = a.data[0].data,
                1 === n.haveVideo && c && (console.log("Output size: " + c.byteLength / 1024 / 1024 + " MB"),
                c = new Blob([c],{
                    type: "video/webm"
                }))),
                r(c)
...
,
function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(e.opentype = {})
}(this, function(e) {
    var t, r;
    ...
    function w(e, t, r) {
        for (; ; ) {
            ...
            if (u < 256)
                ...
                for (a = b(e, p[u -= 257], l[u]),
                s = x(e, r),
                o = n = e.destLen - b(e, h[s], c[s]); o < n + a; ++o)
                    e.dest[e.destLen++] = e.dest[o]
        }
    }
    function S(e) {
        for (var t, r; e.bitcount > 8; )
            e.sourceIndex--,
            e.bitcount -= 8;
        if ((t = 256 * (t = e.source[e.sourceIndex + 1]) + e.source[e.sourceIndex]) !== (65535 & ~(256 * e.source[e.sourceIndex + 3] + e.source[e.sourceIndex + 2])))
            return a;
        for (e.sourceIndex += 4,
        r = t; r; --r)
        ...
        for (var u = 0; u <= 1; u++) {
            ...
            if (0 !== f) {
                ...
                if (!(y < 0)) {
                    ...
                    0 < g && g < 1 && (0 === u && this.addX(T(p[u], l[u], h[u], c[u], g)),
                    1 === u && this.addY(T(p[u], l[u], h[u], c[u], g)));
                    var v = (-d - Math.sqrt(y)) / (2 * f);
                    0 < v && v < 1 && (0 === u && this.addX(T(p[u], l[u], h[u], c[u], v)),
                ...
                if (0 === d)
                    continue;
                var b = -m / d;
                0 < b && b < 1 && (0 === u && this.addX(T(p[u], l[u], h[u], c[u], b)),
    ...
    ,
    O.prototype.curveTo = O.prototype.bezierCurveTo = function(e, t, r, i, a, s) {
        this.commands.push({
            type: "C",
            x1: e,
            y1: t,
    ...
    ,
    O.prototype.quadTo = O.prototype.quadraticCurveTo = function(e, t, r, i) {
        this.commands.push({
            type: "Q",
            x1: e,
            y1: t,
    ...
    O.prototype.getBoundingBox = function() {
        for (var e = new k, t = 0, r = 0, i = 0, a = 0, s = 0; s < this.commands.length; s++) {
            ...
            case "L":
                ...
                break;
            case "Q":
                e.addQuad(i, a, n.x1, n.y1, n.x, n.y),
                i = n.x,
                a = n.y;
                break;
            case "C":
                e.addBezier(i, a, n.x1, n.y1, n.x2, n.y2, n.x, n.y),
                i = n.x,
                a = n.y;
                break;
            case "Z":
    ...
    O.prototype.toPathData = function(e) {
        ...
        for (var i = "", a = 0; a < this.commands.length; a += 1) {
            ...
            "M" === s.type ? i += "M" + r(s.x, s.y) : "L" === s.type ? i += "L" + r(s.x, s.y) : "C" === s.type ? i += "C" + r(s.x1, s.y1, s.x2, s.y2, s.x, s.y) : "Q" === s.type ? i += "Q" + r(s.x1, s.y1, s.x, s.y) : "Z" === s.type && (i += "Z")
        }
        return i
    }
    ,
    ...
    L.BYTE = function(e) {
        return C.argument(e >= 0 && e <= 255, "Byte value should be between 0 and 255."),
        [e]
    }
    ,
    M.BYTE = U(1),
    ...
    M.LONGDATETIME = U(8),
    L.TAG = function(e) {
        return C.argument(4 === e.length, "Tag should be exactly 4 ASCII characters."),
    ...
    ;
    var j, A = "function" == typeof WeakMap && new WeakMap;
    function D(e) {
        return e >= -128 && e <= 127
    }
    function B(e, t, r) {
        for (var i = 0, a = e.length; t < a && i < 64 && 0 === e[t]; )
            ++t,
            ++i;
        return r.push(128 | i - 1),
        t
    }
    function _(e, t, r) {
    ...
    L.OPERAND = function(e, t) {
        ...
        if (Array.isArray(t))
            ...
            r = r.concat(L.NUMBER(e));
        else if ("offset" === t)
            r = r.concat(L.NUMBER32(e));
        else if ("number" === t)
            r = r.concat(L.NUMBER(e));
        else {
            if ("real" !== t)
    ...
    function W(e) {
        1 === e.format ? V.call(this, "coverageTable", [{
            name: "coverageFormat",
            type: "USHORT",
            value: 1
        }].concat(H("glyph", e.glyphs))) : C.assert(!1, "Can't create coverage table format 2 yet.")
    }
    function X(e) {
        V.call(this, "scriptListTable", q("scriptRecord", e, function(e, t) {
            var r = e.script
              , i = r.defaultLangSys;
            return C.assert(!!i, "Unable to write GSUB: script " + e.tag + " has no default language system."),
            [{
                name: "scriptTag" + t,
                type: "TAG",
                value: e.tag
    ...
    function Y(e) {
        V.call(this, "featureListTable", q("featureRecord", e, function(e, t) {
            var r = e.feature;
            return [{
                name: "featureTag" + t,
                type: "TAG",
                ...
                }].concat(H("lookupListIndex", r.lookupListIndexes)))
            }]
        }))
    }
    function J(e, t) {
        V.call(this, "lookupListTable", z("lookup", e, function(e) {
            var r = t[e.lookupType];
            return C.assert(!!r, "Unable to write GSUB lookup type " + e.lookupType + " tables."),
            new V("lookupTable",[{
                name: "lookupType",
                type: "USHORT",
                value: e.lookupType
    ...
    L.OBJECT = function(e) {
        var t = L[e.type];
        return C.argument(void 0 !== t, "No encoding function for type " + e.type),
        t(e.value)
    }
    ,
    M.OBJECT = function(e) {
        var t = M[e.type];
        return C.argument(void 0 !== t, "No sizeOf function for type " + e.type),
        t(e.value)
    }
    ,
    L.TABLE = function(e) {
        for (var t = [], r = e.fields.length, i = [], a = [], s = 0; s < r; s += 1) {
            ...
            void 0 === p && (p = n.value);
            var l = o(p);
            "TABLE" === n.type ? (a.push(t.length),
            t = t.concat([0, 0]),
            i.push(l)) : t = t.concat(l)
        }
    ...
    ie.prototype.parseString = function(e) {
        ...
        for (var a = 0; a < e; a++)
            i += String.fromCharCode(t.getUint8(r + a));
        return i
    }
    ,
    ...
    ie.prototype.parseValueRecord = function(e) {
        if (void 0 === e && (e = this.parseUShort()),
        0 !== e) {
            var t = {};
            return 1 & e && (t.xPlacement = this.parseShort()),
            2 & e && (t.yPlacement = this.parseShort()),
            4 & e && (t.xAdvance = this.parseShort()),
            8 & e && (t.yAdvance = this.parseShort()),
            16 & e && (t.xPlaDevice = void 0,
            this.parseShort()),
            32 & e && (t.yPlaDevice = void 0,
            this.parseShort()),
            64 & e && (t.xAdvDevice = void 0,
            this.parseShort()),
            128 & e && (t.yAdvDevice = void 0,
            this.parseShort()),
            t
        }
    }
    ...
    ie.prototype.parsePointer = function(e) {
        ...
        if (t > 0)
            return new ie(this.data,this.offset + t).parseStruct(e)
    }
    ,
    ...
    ie.prototype.parseListOfLists = function(e) {
        for (var t = this.parseOffset16List(), r = t.length, i = this.relativeOffset, a = new Array(r), s = 0; s < r; s++) {
            var n = t[s];
            if (0 !== n)
                if (this.relativeOffset = n,
                e) {
                    for (var o = this.parseOffset16List(), p = new Array(o.length), l = 0; l < o.length; l++)
                        this.relativeOffset = n + o[l],
                        p[l] = e.call(this);
                    a[s] = p
                } else
    ...
    var ae = {
        reserved: ie.uShort,
        reqFeatureIndex: ie.uShort,
        featureIndexes: ie.uShortList
    };
    ie.prototype.parseScriptList = function() {
        return this.parsePointer(ie.recordList({
            tag: ie.tag,
            script: ie.pointer({
                defaultLangSys: ie.pointer(ae),
                langSysRecords: ie.recordList({
                    tag: ie.tag,
                    langSys: ie.pointer(ae)
                })
            })
        })) || []
    }
    ...
    ie.prototype.parseFeatureList = function() {
        return this.parsePointer(ie.recordList({
            tag: ie.tag,
            feature: ie.pointer({
                featureParams: ie.offset16,
                lookupListIndexes: ie.uShortList
            })
        })) || []
    }
    ,
    ie.prototype.parseLookupList = function(e) {
        return this.parsePointer(ie.list(ie.pointer(function() {
    ...
    ie.prototype.parseFeatureVariationsList = function() {
        return this.parsePointer32(function() {
            var e = this.parseUShort()
              , t = this.parseUShort();
            return C.argument(1 === e && t < 1, "GPOS/GSUB feature variations table unknown."),
    ...
    var se = {
        ...
        getOffset: function(e, t, r) {
            for (var i = 0, a = 0; a < r; a += 1)
                i <<= 8,
                i += e.getUint8(t + a);
            return i
        },
        getBytes: function(e, t, r) {
            for (var i = [], a = t; a < r; a += 1)
                i.push(e.getUint8(a));
            return i
        },
    ...
    var oe = {
        parse: function(e, t) {
            ...
            for (var i = -1, a = r.numTables - 1; a >= 0; a -= 1) {
                ...
                if (3 === s && (0 === n || 1 === n || 10 === n) || 0 === s && (0 === n || 1 === n || 2 === n || 3 === n || 4 === n)) {
            ...
            12 === r.format)
                !function(e, t) {
                    ...
                    e.glyphIndexMap = {};
                    for (var i = 0; i < r; i += 1)
                        for (var a = t.parseULong(), s = t.parseULong(), n = t.parseULong(), o = a; o <= s; o += 1)
                            e.glyphIndexMap[o] = n,
                            n++
                }(r, o);
            else {
                ...
                !function(e, t, r, i, a) {
                    ...
                    t.skip("uShort", 3),
                    e.glyphIndexMap = {};
                    for (var n = new se.Parser(r,i + a + 14), o = new se.Parser(r,i + a + 16 + 2 * s), p = new se.Parser(r,i + a + 16 + 4 * s), l = new se.Parser(r,i + a + 16 + 6 * s), h = i + a + 16 + 8 * s, c = 0; c < s - 1; c += 1)
                        for (var u = void 0, d = n.parseUShort(), f = o.parseUShort(), m = p.parseShort(), y = l.parseUShort(), g = f; g <= d; g += 1)
                            0 !== y ? (h = l.offset + l.relativeOffset - 2,
                            h += y,
                            h += 2 * (g - f),
                            0 !== (u = se.getUShort(r, h)) && (u = u + m & 65535)) : u = g + m & 65535,
                            e.glyphIndexMap[g] = u
                }(r, o, e, t, i)
            }
            return r
        ...
        make: function(e) {
            ...
            for (a.segments = [],
            t = 0; t < e.length; t += 1) {
                for (var s = e.get(t), n = 0; n < s.unicodes.length; n += 1)
                    ne(a, s.unicodes[n], t);
            ...
            for (t = 0; t < o; t += 1) {
                var m = a.segments[t];
                m.end <= 65535 && m.start <= 65535 ? (l = l.concat({
                    name: "end_" + t,
                    type: "USHORT",
                    value: m.end
                }),
                ...
                void 0 !== m.glyphId && (d = d.concat({
                    name: "glyph_" + t,
                    type: "USHORT",
                    value: m.glyphId
                }))) : p += 1,
                r || void 0 === m.glyphIndex || (f = (f = (f = f.concat({
                    name: "cmap12Start_" + t,
                    type: "ULONG",
                    value: m.start
                })).concat({
            ...
            a.cmap4Length = 14 + 2 * l.length + 2 + 2 * h.length + 2 * c.length + 2 * u.length + 2 * d.length,
            !r) {
                var y = 16 + 4 * f.length;
    ...
    ue.prototype.charToGlyphIndex = function(e) {
        ...
        if (r)
            for (var i = 0; i < r.length; i += 1)
                for (var a = r.get(i), s = 0; s < a.unicodes.length; s += 1)
                    if (a.unicodes[s] === t)
                        return i;
        return null
    }
    ...
    ge.prototype.bindConstructorValues = function(e) {
        ...
        Object.defineProperty(this, "path", (t = e.path,
        r = t || new O,
        {
            configurable: !0,
            get: function() {
    ...
    ge.prototype.getPath = function(e, t, r, i, a) {
        ...
        var o = i.xScale
          , p = i.yScale;
        if (i.hinting && a && a.hinting && (n = this.path && a.hinting.exec(this, r)),
        n)
            s = a.hinting.getCommands(n),
            e = Math.round(e),
            t = Math.round(t),
            o = p = 1;
        else {
        ...
        for (var h = new O, c = 0; c < s.length; c += 1) {
            var u = s[c];
            "M" === u.type ? h.moveTo(e + u.x * o, t + -u.y * p) : "L" === u.type ? h.lineTo(e + u.x * o, t + -u.y * p) : "Q" === u.type ? h.quadraticCurveTo(e + u.x1 * o, t + -u.y1 * p, e + u.x * o, t + -u.y * p) : "C" === u.type ? h.curveTo(e + u.x1 * o, t + -u.y1 * p, e + u.x2 * o, t + -u.y2 * p, e + u.x * o, t + -u.y * p) : "Z" === u.type && h.closePath()
        }
        return h
    }
    ,
    ge.prototype.getContours = function() {
        ...
        for (var e = [], t = [], r = 0; r < this.points.length; r += 1) {
            var i = this.points[r];
            t.push(i),
            i.lastPointOfContour && (e.push(t),
            t = [])
        }
        return C.argument(0 === t.length, "There are still points left in the current contour."),
        e
    }
    ,
    ge.prototype.getMetrics = function() {
        for (var e = this.path.commands, t = [], r = [], i = 0; i < e.length; i += 1) {
            ...
            "Z" !== a.type && (t.push(a.x),
            r.push(a.y)),
            "Q" !== a.type && "C" !== a.type || (t.push(a.x1),
            r.push(a.y1)),
            "C" === a.type && (t.push(a.x2),
            r.push(a.y2))
        }
        var s = {
        ...
        return isFinite(s.xMin) || (s.xMin = 0),
    ...
    ge.prototype.drawPoints = function(e, t, r, i) {
        function a(t, r, i, a) {
            ...
            for (var n = 0; n < t.length; n += 1)
                e.moveTo(r + t[n].x * a, i + t[n].y * a),
                e.arc(r + t[n].x * a, i + t[n].y * a, 2, 0, s, !1);
            e.closePath(),
            e.fill()
        }
        t = void 0 !== t ? t : 0,
    ...
    function Se(e, t, r) {
        var i, a, s = [], n = [], o = se.getCard16(e, t);
        if (0 !== o) {
            var p = se.getByte(e, t + 2);
            i = t + (o + 1) * p + 2;
            for (var l = t + 3, h = 0; h < o + 1; h += 1)
                s.push(se.getOffset(e, l, p)),
                l += p;
            a = i + s[o]
        } else
            a = t + 2;
        ...
        for (var i, a = {}, s = 0; s < t.length; s += 1) {
            ...
            if (Array.isArray(n.type)) {
                ...
                for (var p = 0; p < n.type.length; p++)
                    void 0 === (i = void 0 !== e[n.op] ? e[n.op][p] : void 0) && (i = void 0 !== n.value && void 0 !== n.value[p] ? n.value[p] : null),
                    "SID" === n.type[p] && (i = ke(r, i)),
                    o[p] = i;
                a[n.name] = o
            } else
                void 0 === (i = e[n.op]) && (i = void 0 !== n.value ? n.value : null),
                "SID" === n.type && (i = ke(r, i)),
                a[n.name] = i
        }
        return a
    ...
    function Le(e, t, r, i) {
        for (var a = [], s = 0; s < r.length; s += 1) {
            ...
            if (0 !== o && 0 !== p) {
                var l = Ne(e, p + t, o, i);
                if (n._defaultWidthX = l.defaultWidthX,
                n._nominalWidthX = l.nominalWidthX,
                0 !== l.subrs) {
                    var h = Se(e, p + l.subrs + t);
                    n._subrs = h.objects,
                    n._subrsBias = we(n._subrs)
                }
                n._privateDict = l
            }
            a.push(n)
    ...
    function Me(e, t, r) {
        var i, a, s, n, o, p, l, h, c = new O, u = [], d = 0, f = !1, m = !1, y = 0, g = 0;
        if (e.isCIDFont) {
            ...
            for (var v, b, S, E, T, k, O, Z, R, C, N, L, M = 0; M < l.length; ) {
                ...
                case 12:
                    ...
                    case 37:
                        ...
                        N = R + u.shift(),
                        L = C + u.shift(),
                        Math.abs(N - y) > Math.abs(L - g) ? y = N + u.shift() : g = L + u.shift(),
                        c.curveTo(i, a, s, n, O, Z),
                        c.curveTo(R, C, N, L, y, g);
                        break;
                    default:
                ...
                case 31:
                    ...
                    break;
                default:
                    U < 32 ? console.log("Glyph " + t.index + ": unknown operator " + U) : U < 247 ? u.push(U - 139) : U < 251 ? (v = l[M],
                    M += 1,
                    u.push(256 * (U - 247) + v + 108)) : U < 255 ? (v = l[M],
                    M += 1,
                    u.push(256 * -(U - 251) - v - 108)) : (v = l[M],
                    b = l[M + 1],
                    S = l[M + 2],
                    E = l[M + 3],
                    M += 4,
    ...
    function Ue(e, t) {
        var r, i = pe.indexOf(e);
        return i >= 0 && (r = i),
        (i = t.indexOf(e)) >= 0 ? r = i + pe.length : (r = pe.length + t.length,
        t.push(e)),
        r
    }
    function Ie(e, t, r) {
        for (var i = {}, a = 0; a < e.length; a += 1) {
            var s = e[a]
              , n = t[s.name];
            void 0 === n || Pe(n, s.value) || ("SID" === s.type && (n = Ue(n, r)),
            i[s.op] = {
                name: s.name,
                type: s.type,
                value: n
    ...
    function je(e, t) {
        ...
        return r.dict = Ie(Ze, e, t),
        r
    }
    function Ae(e) {
        var t = new K.Record("Top DICT INDEX",[{
            name: "topDicts",
            type: "INDEX",
            value: []
        }]);
    ...
    var Be = {
        parse: function(e, t, r) {
            r.tables.cff = {};
            var i = Se(e, Se(e, function(e, t) {
                var r = {};
                return r.formatMajor = se.getCard8(e, t),
                ...
                r.endOffset = t + 4,
                r
            }(e, t).endOffset, se.bytesToString).endOffset)
              , a = Se(e, i.endOffset, se.bytesToString)
              , s = Se(e, a.endOffset);
            r.gsubrs = s.objects,
            r.gsubrsBias = we(r.gsubrs);
            var n = Le(e, t, i.objects, a.objects);
            if (1 !== n.length)
                throw new Error("CFF table has too many fonts in 'FontSet' - count of fonts NameIndex.length = " + n.length);
            var o = n[0];
            if (r.tables.cff.topDict = o,
            o._privateDict && (r.defaultWidthX = o._privateDict.defaultWidthX,
            ...
            r.isCIDFont) {
                ...
                o._fdSelect = function(e, t, r, i) {
                    var a, s = [], n = new se.Parser(e,t), o = n.parseCard8();
                    if (0 === o)
                        for (var p = 0; p < r; p++) {
                            if ((a = n.parseCard8()) >= i)
                                throw new Error("CFF table CID Font FDSelect has bad FD index value " + a + " (FD count " + i + ")");
                            s.push(a)
                        }
                    else {
                        if (3 !== o)
                            throw new Error("CFF Table CID Font FDSelect table has unsupported format " + o);
                        var l, h = n.parseCard16(), c = n.parseCard16();
                        if (0 !== c)
            ...
            if (r.defaultWidthX = u.defaultWidthX,
            r.nominalWidthX = u.nominalWidthX,
            0 !== u.subrs) {
                var d = Se(e, c + u.subrs);
                r.subrs = d.objects,
                r.subrsBias = we(r.subrs)
            } else
                r.subrs = [],
                r.subrsBias = 0;
            ...
            0 === o.encoding ? r.cffEncoding = new fe(le,m) : 1 === o.encoding ? r.cffEncoding = new fe(he,m) : r.cffEncoding = function(e, t, r) {
                var i, a = {}, s = new se.Parser(e,t), n = s.parseCard8();
                if (0 === n)
                    for (var o = s.parseCard8(), p = 0; p < o; p += 1)
                        a[i = s.parseCard8()] = p;
                else {
                    if (1 !== n)
                        throw new Error("Unknown encoding format " + n);
                    var l = s.parseCard8();
                    i = 1;
                    for (var h = 0; h < l; h += 1)
        ...
        make: function(e, t) {
            ...
            i.charStringsIndex = function(e) {
                for (var t = new K.Record("CharStrings INDEX",[{
                    name: "charStrings",
                    type: "INDEX",
                    value: []
                }]), r = 0; r < e.length; r += 1) {
            ...
            i.privateDict = function(e, t) {
                ...
                return r.dict = Ie(Re, e, t),
                r
            }({}, p),
            i.stringIndex = function(e) {
                var t = new K.Record("String INDEX",[{
                    name: "strings",
                    type: "INDEX",
                    value: []
                }]);
    ...
    var Ve = {
        ...
        parse: function(e, t) {
            var r = new se.Parser(e,t)
              , i = r.parseULong();
            C.argument(1 === i, "Unsupported ltag table version."),
            r.skip("uLong", 1);
    ...
    var He = {
        parse: function(e, t) {
            ...
            1 === r.version && (r.maxPoints = i.parseUShort(),
      ...
      , ze = ["copyright", "fontFamily", "fontSubfamily", "uniqueID", "fullName", "version", "postScriptName", "trademark", "manufacturer", "designer", "description", "manufacturerURL", "designerURL", "license", "licenseURL", "reserved", "preferredFamily", "preferredSubfamily", "compatibleFullName", "sampleText", "postScriptFindFontName", "wwsFamily", "wwsSubfamily"]
      , qe = {
        0: "en",
        1: "fr",
        2: "de",
    ...
    var it = {
        parse: function(e, t, r) {
            for (var i = {}, a = new se.Parser(e,t), s = a.parseUShort(), n = a.parseUShort(), o = a.offset + a.parseUShort(), p = 0; p < n; p++) {
                var l = a.parseUShort()
                  , h = a.parseUShort()
                  , c = a.parseUShort()
                  , u = a.parseUShort()
        ...
        make: function(e, t) {
            ...
            for (var n in e) {
                ...
                r = parseInt(o),
                isNaN(r))
                    throw new Error('Name table entry "' + n + '" does not exist, see nameTableNames for complete list.');
                a[r] = e[n],
                i.push(r)
            }
    ...
    var st = {
        parse: function(e, t) {
            ...
            r.panose = [];
            for (var a = 0; a < 10; a++)
                r.panose[a] = i.parseByte();
            return r.ulUnicodeRange1 = i.parseULong(),
            ...
            r.version >= 1 && (r.ulCodePageRange1 = i.parseULong(),
            r.ulCodePageRange2 = i.parseULong()),
            r.version >= 2 && (r.sxHeight = i.parseShort(),
    ...
    var nt = {
        parse: function(e, t) {
            var r = {}
              , i = new se.Parser(e,t);
            switch (r.version = i.parseVersion(),
            ...
            case 2:
                ...
                for (var a = 0; a < r.numberOfGlyphs; a++)
                    r.glyphNameIndex[a] = i.parseUShort();
                r.names = [];
    ...
    ot[2] = function() {
        var e = this.parseUShort();
        return C.argument(1 === e, "GSUB Multiple Substitution Subtable identifier-format must be 1"),
        {
            substFormat: e,
            coverage: this.parsePointer(ie.coverage),
    ...
    ot[3] = function() {
        var e = this.parseUShort();
        return C.argument(1 === e, "GSUB Alternate Substitution Subtable identifier-format must be 1"),
        {
            substFormat: e,
            coverage: this.parsePointer(ie.coverage),
    ...
    ot[4] = function() {
        var e = this.parseUShort();
        return C.argument(1 === e, "GSUB ligature table identifier-format must be 1"),
        {
            substFormat: e,
            coverage: this.parsePointer(ie.coverage),
    ...
    ;
    var pt = {
        sequenceIndex: ie.uShort,
        lookupListIndex: ie.uShort
    };
    ot[5] = function() {
        var e = this.offset + this.relativeOffset
          , t = this.parseUShort();
            ...
            return {
                ...
                ruleSets: this.parseListOfLists(function() {
                    ...
                    return {
                        ...
                        lookupRecords: this.parseRecordList(t, pt)
                    }
                })
            };
        if (2 === t)
    ...
    ot[8] = function() {
        var e = this.parseUShort();
        return C.argument(1 === e, "GSUB Reverse Chaining Contextual Single Substitution Subtable identifier-format must be 1"),
        {
            substFormat: e,
            coverage: this.parsePointer(ie.coverage),
            backtrackCoverage: this.parseList(ie.pointer(ie.coverage)),
    ...
    var lt = new Array(9);
    lt[1] = function(e) {
        return 1 === e.substFormat ? new K.Table("substitutionTable",[{
            name: "substFormat",
            type: "USHORT",
            value: 1
        }, {
            name: "coverage",
            type: "TABLE",
            value: new K.Coverage(e.coverage)
        }, {
            name: "deltaGlyphID",
            type: "USHORT",
    ...
    ,
    lt[3] = function(e) {
        return C.assert(1 === e.substFormat, "Lookup type 3 substFormat must be 1."),
        new K.Table("substitutionTable",[{
            name: "substFormat",
            type: "USHORT",
            value: 1
            ...
            type: "TABLE",
            value: new K.Coverage(e.coverage)
        }].concat(K.tableList("altSet", e.alternateSets, function(e) {
            return new K.Table("alternateSetTable",K.ushortList("alternate", e))
        })))
    }
    ,
    lt[4] = function(e) {
        return C.assert(1 === e.substFormat, "Lookup type 4 substFormat must be 1."),
        new K.Table("substitutionTable",[{
            name: "substFormat",
            type: "USHORT",
            value: 1
            ...
            type: "TABLE",
            value: new K.Coverage(e.coverage)
        }].concat(K.tableList("ligSet", e.ligatureSets, function(e) {
            return new K.Table("ligatureSetTable",K.tableList("ligature", e, function(e) {
                return new K.Table("ligatureTable",[{
                    name: "ligGlyph",
                    type: "USHORT",
                    value: e.ligGlyph
                }].concat(K.ushortList("component", e.components, e.components.length + 1)))
            }))
        })))
    }
    ;
    var ht = {
        parse: function(e, t) {
            var r = new ie(e,t = t || 0)
              , i = r.parseVersion(1);
            return C.argument(1 === i || 1.1 === i, "Unsupported GSUB table version."),
            1 === i ? {
                version: i,
        ...
        make: function(e) {
            return new K.Table("GSUB",[{
                ...
                name: "scripts",
                type: "TABLE",
                value: new K.ScriptList(e.scripts)
            }, {
                name: "features",
                type: "TABLE",
                value: new K.FeatureList(e.features)
            }, {
                name: "lookups",
                type: "TABLE",
                value: new K.LookupList(e.lookups,lt)
            }])
        }
    };
    var ct = {
        parse: function(e, t) {
            var r = new se.Parser(e,t)
              , i = r.parseULong();
            C.argument(1 === i, "Unsupported META table version."),
            r.parseULong(),
            r.parseULong();
            for (var a = r.parseULong(), s = {}, n = 0; n < a; n++) {
                var o = r.parseTag()
    ...
    function mt(e) {
        ...
        for (var n = 0; n < e.length; n += 1) {
            ...
            a.push({
                name: o.tableName + " table",
                type: "RECORD",
                value: o
            }),
            s += p,
            C.argument(!isNaN(s), "Something went wrong calculating the offset."); s % 4 != 0; )
                s += 1,
                a.push({
                    name: "padding",
                    type: "BYTE",
    ...
    var gt = {
        ...
        fontToTable: function(e) {
            ...
            C.uniqueID || (C.uniqueID = {
                en: e.getEnglishName("manufacturer") + ":" + Z
            }),
    ...
    function Zt(e, t, r, i, a) {
        var s;
        return (t & i) > 0 ? (s = e.parseByte(),
        0 == (t & a) && (s = -s),
        s = r + s) : s = (t & a) > 0 ? r : r + e.parseShort(),
        s
    }
    function Rt(e, t, r) {
        var i, a, s = new se.Parser(t,r);
        if (e.numberOfContours = s.parseShort(),
        e._xMin = s.parseShort(),
        e._yMin = s.parseShort(),
        e._xMax = s.parseShort(),
        e._yMax = s.parseShort(),
        e.numberOfContours > 0) {
            for (var n = e.endPointIndices = [], o = 0; o < e.numberOfContours; o += 1)
                n.push(s.parseUShort());
            ...
            for (var h = 0; h < l; h += 1)
                ...
                i.push(a),
                (8 & a) > 0)
                    for (var c = s.parseByte(), u = 0; u < c; u += 1)
                        i.push(a),
                        h += 1;
            if (C.argument(i.length === l, "Bad flags."),
            n.length > 0) {
                var d, f = [];
                if (l > 0) {
                    for (var m = 0; m < l; m += 1)
                    ...
                    for (var y = 0, g = 0; g < l; g += 1)
                        a = i[g],
                        (d = f[g]).x = Zt(s, a, y, 2, 16),
                        y = d.x;
                    for (var v = 0, b = 0; b < l; b += 1)
                        a = i[b],
                        (d = f[b]).y = Zt(s, a, v, 4, 32),
                        v = d.y
                }
                e.points = f
            } else
            ...
            for (var x = !0; x; ) {
                ...
                (1 & i) > 0 ? (2 & i) > 0 ? (P.dx = s.parseShort(),
                P.dy = s.parseShort()) : P.matchedPoints = [s.parseUShort(), s.parseUShort()] : (2 & i) > 0 ? (P.dx = s.parseChar(),
                P.dy = s.parseChar()) : P.matchedPoints = [s.parseByte(), s.parseByte()],
                (8 & i) > 0 ? P.xScale = P.yScale = s.parseF2Dot14() : (64 & i) > 0 ? (P.xScale = s.parseF2Dot14(),
                P.yScale = s.parseF2Dot14()) : (128 & i) > 0 && (P.xScale = s.parseF2Dot14(),
    ...
    Pt.prototype = {
        ...
        getLangSysTable: function(e, t, r) {
            ...
            if (i) {
                ...
                if (a >= 0)
                    return i.langSysRecords[a].langSys;
                if (r) {
                    var s = {
                        tag: t,
                        langSys: {
                    ...
                    return i.langSysRecords.splice(-1 - a, 0, s),
                    s.langSys
                }
            }
        },
        getFeatureTable: function(e, t, r, i) {
            ...
            if (a) {
                for (var s, n = a.featureIndexes, o = this.font.tables[this.tableName].features, p = 0; p < n.length; p++)
                    if ((s = o[n[p]]).tag === r)
                        return s.feature;
                if (i) {
                    var l = o.length;
                    return C.assert(0 === l || r >= o[l - 1].tag, "Features must be added in alphabetical order."),
                    s = {
                        tag: r,
                        feature: {
                            params: 0,
        ...
        getLookupTables: function(e, t, r, i, a) {
            var s = this.getFeatureTable(e, t, r, a)
              , n = [];
            if (s) {
                for (var o, p = s.lookupListIndexes, l = this.font.tables[this.tableName].lookups, h = 0; h < p.length; h++)
        ...
        expandCoverage: function(e) {
            ...
            for (var t = [], r = e.ranges, i = 0; i < r.length; i++)
                for (var a = r[i], s = a.start, n = a.end, o = s; o <= n; o++)
                    t.push(o);
            return t
        }
    },
    ...
    St.prototype.getAlternates = function(e, t, r) {
        for (var i = [], a = this.getLookupTables(t, r, e, 3), s = 0; s < a.length; s++)
            for (var n = a[s].subtables, o = 0; o < n.length; o++)
                for (var p = n[o], l = this.expandCoverage(p.coverage), h = p.alternateSets, c = 0; c < l.length; c++)
                    i.push({
                        sub: l[c],
                        by: h[c]
                    });
    ...
    St.prototype.getLigatures = function(e, t, r) {
        for (var i = [], a = this.getLookupTables(t, r, e, 4), s = 0; s < a.length; s++)
            for (var n = a[s].subtables, o = 0; o < n.length; o++)
                for (var p = n[o], l = this.expandCoverage(p.coverage), h = p.ligatureSets, c = 0; c < l.length; c++)
                    for (var u = l[c], d = h[c], f = 0; f < d.length; f++) {
                        var m = d[f];
                        i.push({
                            sub: [u].concat(m.components),
                            by: m.ligGlyph
                        })
                    }
        return i
    ...
    St.prototype.addSingle = function(e, t, r, i) {
        var a = Tt(this.getLookupTables(r, i, e, 1, !0)[0], 2, {
            substFormat: 2,
            coverage: {
                format: 1,
                glyphs: []
        ...
        n < 0 && (n = -1 - n,
        a.coverage.glyphs.splice(n, 0, s),
        a.substitute.splice(n, 0, 0)),
        a.substitute[n] = t.by
    }
    ,
    St.prototype.addAlternate = function(e, t, r, i) {
        var a = Tt(this.getLookupTables(r, i, e, 3, !0)[0], 1, {
            substFormat: 1,
            coverage: {
                format: 1,
                glyphs: []
    ...
    St.prototype.addLigature = function(e, t, r, i) {
        ...
        a.subtables[0] = s),
        C.assert(1 === s.coverage.format, "Ligature: unable to modify coverage table format " + s.coverage.format);
        var n = t.sub[0]
          , o = t.sub.slice(1)
          , p = {
            ligGlyph: t.by,
        ...
        if (l >= 0) {
            for (var h = s.ligatureSets[l], c = 0; c < h.length; c++)
                if (Et(h[c].components, o))
                    return;
            h.push(p)
        } else
            l = -1 - l,
            s.coverage.glyphs.splice(l, 0, n),
            s.ligatureSets.splice(l, 0, [p])
    }
    ,
    ...
    var Mt, Ut, It, jt, At = {
        ...
        parse: function(e, t, r, i) {
            for (var a = new xe.GlyphSet(i), s = 0; s < r.length - 1; s += 1) {
                var n = r[s];
                n !== r[s + 1] ? a.push(s, xe.ttfGlyphLoader(i, s, Rt, e, t + n, Lt)) : a.push(s, xe.glyphLoader(i, s))
            }
            return a
        }
    };
      ...
      , qt = {
        ...
        interpolate: function(e, t, r, i) {
            ...
            if (!i || i === this)
                ...
                p = t.x - t.xo,
                l = r.x - r.xo,
                0 === (h = (n = Math.abs(a)) + (o = Math.abs(s))) ? void (e.x = e.xo + (p + l) / 2) : void (e.x = e.xo + (p * o + l * n) / h);
      ...
      , Wt = {
        ...
        interpolate: function(e, t, r, i) {
            ...
            if (!i || i === this)
                ...
                p = t.y - t.yo,
                l = r.y - r.yo,
                0 === (h = (n = Math.abs(a)) + (o = Math.abs(s))) ? void (e.y = e.yo + (p + l) / 2) : void (e.y = e.yo + (p * o + l * n) / h);
            a = i.distance(e, t, !0, !0),
            s = i.distance(e, r, !0, !0),
            p = i.distance(t, t, !1, !0),
            l = i.distance(r, r, !1, !0),
    ...
    function Yt(e, t) {
        ...
        return t /= r,
        1 === (e /= r) && 0 === t ? qt : 0 === e && 1 === t ? Wt : new Xt(e,t)
    }
    function Jt(e, t, r, i) {
    ...
    function rr(t, r) {
        e.DEBUG && console.log(r.step, "SVTCA[" + t.axis + "]"),
        r.fv = r.pv = r.dpv = t
    }
    function ir(t, r) {
        e.DEBUG && console.log(r.step, "SPVTCA[" + t.axis + "]"),
        r.pv = r.dpv = t
    }
    function ar(t, r) {
        e.DEBUG && console.log(r.step, "SFVTCA[" + t.axis + "]"),
        r.fv = t
    }
    function sr(t, r) {
        var i, a, s = r.stack, n = s.pop(), o = s.pop(), p = r.z2[n], l = r.z1[o];
    ...
    function or(t) {
        e.DEBUG && console.log(t.step, "POP[]"),
        t.stack.pop()
    }
    function pr(t, r) {
        var i = r.stack.pop()
        ...
        t && (o = r.round(o)),
        s.setRelative(a, Kt, o, n),
        s.touch(a),
        r.rp0 = r.rp1 = i
    }
    function lr(t, r) {
        var i, a, s, n = r.z2, o = n.length - 2;
        e.DEBUG && console.log(r.step, "IUP[" + t.axis + "]");
        for (var p = 0; p < o; p++)
            i = n[p],
            t.touched(i) || (a = i.prevTouched(t)) !== i && (a === (s = i.nextTouched(t)) && t.setRelative(i, i, t.distance(a, a, !1, !0), t, !0),
    ...
    function hr(t, r) {
        for (var i = r.stack, a = t ? r.rp1 : r.rp2, s = (t ? r.z0 : r.z1)[a], n = r.fv, o = r.pv, p = r.loop, l = r.z2; p--; ) {
            ...
            n.touch(c),
            e.DEBUG && console.log(r.step, (r.loop > 1 ? "loop " + (r.loop - p) + ": " : "") + "SHP[" + (t ? "rp1" : "rp2") + "]", h)
        }
        r.loop = 1
    }
    function cr(t, r) {
        ...
        do {
            h !== s && n.setRelative(h, h, c, o),
            h = h.nextPointOnContour
        } while (h !== l)
    }
    function ur(t, r) {
        var i, a, s = r.stack, n = t ? r.rp1 : r.rp2, o = (t ? r.z0 : r.z1)[n], p = r.fv, l = r.pv, h = s.pop();
        switch (e.DEBUG && console.log(r.step, "SHZ[" + t + "]", h),
        h) {
        case 0:
            i = r.tZone;
            break;
        ...
        for (var c = l.distance(o, o, !1, !0), u = i.length - 2, d = 0; d < u; d++)
            a = i[d],
            p.setRelative(a, a, c, l)
    }
    function dr(t, r) {
        var i = r.stack
          , a = i.pop() / 64
    ...
    function mr(t, r) {
        var i = r.stack
          , a = i.pop()
          , s = r.z2[a];
        e.DEBUG && console.log(r.step, "GC[" + t + "]", a),
        i.push(64 * r.dpv.distance(s, Kt, t, !1))
    }
    function yr(t, r) {
        var i = r.stack
          , a = i.pop()
        ...
        e.DEBUG && console.log(r.step, "MD[" + t + "]", a, s, "->", p),
        r.stack.push(Math.round(64 * p))
    }
    function gr(t, r) {
        var i = r.stack
          , a = i.pop()
        ...
        for (var c = 0; c < a; c++) {
            ...
            if (p + ((240 & d) >> 4) === o) {
                var f = (15 & d) - 8;
                f >= 0 && f++,
                e.DEBUG && console.log(r.step, "DELTAPFIX", u, "by", f * l);
                var m = h[u];
    ...
    function vr(t, r) {
        var i = r.stack
          , a = i.pop();
        e.DEBUG && console.log(r.step, "ROUND[]"),
        i.push(64 * r.round(a / 64))
    }
    function br(t, r) {
        var i = r.stack
          , a = i.pop()
        ...
        for (var p = 0; p < a; p++) {
            ...
            if (n + ((240 & h) >> 4) === s) {
                ...
                c >= 0 && c++;
                var u = c * o;
                e.DEBUG && console.log(r.step, "DELTACFIX", l, "by", u),
                r.cvt[l] += u
            }
        }
    }
    ...
    function Sr(t, r, i, a, s, n) {
        var o, p, l, h, c = n.stack, u = t && c.pop(), d = c.pop(), f = n.rp0, m = n.z0[f], y = n.z1[d], g = n.minDis, v = n.fv, b = n.dpv;
        l = (p = o = b.distance(y, m, !0, !0)) >= 0 ? 1 : -1,
        p = Math.abs(p),
        t && (h = n.cvt[u],
        a && Math.abs(p - h) < n.cvCutIn && (p = h)),
        i && p < g && (p = g),
        a && (p = n.round(p)),
        v.setRelative(y, m, l * p, b),
        v.touch(y),
        e.DEBUG && console.log(n.step, (t ? "MIRP[" : "MDRP[") + (r ? "M" : "m") + (i ? ">" : "_") + (a ? "R" : "_") + (0 === s ? "Gr" : 1 === s ? "Bl" : 2 === s ? "Wh" : "") + "]", t ? u + "(" + n.cvt[u] + "," + h + ")" : "", d, "(d =", o, "->", l * p, ")"),
        n.rp1 = n.rp0,
        n.rp2 = d,
        r && (n.rp0 = d)
    }
        ...
        if (!(this._errorState > 2)) {
            ...
            if (!a || a.ppem !== r) {
                ...
                if (!s) {
                    ...
                    s.font = i,
                    e.DEBUG && (console.log("---EXEC FPGM---"),
                    s.step = -1);
                    try {
                        Ut(s)
                    } catch (e) {
                        return console.log("Hinting error in FPGM:" + e),
                        void (this._errorState = 3)
                    }
                }
                $t.prototype = s,
                (a = this._prepState = new $t("prep",i.tables.prep)).ppem = r;
                var n = i.tables.cvt;
                if (n)
            ...
            if (!(this._errorState > 1))
                try {
                    ...
                    return this._errorState < 1 && (console.log("Hinting error:" + e),
    ...
    ,
    It = function(t, r) {
        var i, a, s, n = r.ppem / r.font.unitsPerEm, o = n, p = t.components;
        if ($t.prototype = r,
        p) {
            var l = r.font;
            a = [],
            ...
            t.instructions && !s.inhibitGridFit && ((s = new $t("glyf",t.instructions)).gZone = s.z0 = s.z1 = s.z2 = a,
            s.contours = i,
            a.push(new Jt(0,0), new Jt(Math.round(t.advanceWidth * n),0)),
            e.DEBUG && (console.log("---EXEC COMPOSITE---"),
            s.step = -1),
            Ut(s),
            a.length -= 2)
        } else
            s = new $t("glyf",t.instructions),
            e.DEBUG && (console.log("---EXEC GLYPH---"),
            s.step = -1),
            jt(t, s, n, o),
            a = s.gZone;
        return a
    ...
    ,
    jt = function(t, r, i, a) {
        for (var s, n, o, p = t.points || [], l = p.length, h = r.gZone = r.z0 = r.z1 = r.z2 = [], c = r.contours = [], u = 0; u < l; u++)
            s = p[u],
            h[u] = new Jt(s.x * i,s.y * a,s.lastPointOfContour,s.onCurve);
        for (var d = 0; d < l; d++)
            s = h[d],
            n || (n = s,
            c.push(d)),
            s.lastPointOfContour ? (s.nextPointOnContour = n,
            n.prevPointOnContour = s,
            n = void 0) : (o = h[d + 1],
            s.nextPointOnContour = o,
            o.prevPointOnContour = s);
        if (!r.inhibitGridFit) {
            if (e.DEBUG) {
                console.log("PROCESSING GLYPH", r.stack);
                for (var f = 0; f < l; f++)
                    console.log(f, h[f].x, h[f].y)
            }
            if (h.push(new Jt(0,0), new Jt(Math.round(t.advanceWidth * i),0)),
            Ut(r),
            h.length -= 2,
            e.DEBUG) {
                console.log("FINISHED GLYPH", r.stack);
                for (var m = 0; m < l; m++)
                    console.log(m, h[m].x, h[m].y)
            }
        }
    }
    ,
    ...
    ,
    Mt = [rr.bind(void 0, Wt), rr.bind(void 0, qt), ir.bind(void 0, Wt), ir.bind(void 0, qt), ar.bind(void 0, Wt), ar.bind(void 0, qt), sr.bind(void 0, 0), sr.bind(void 0, 1), nr.bind(void 0, 0), nr.bind(void 0, 1), function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "SPVFS[]", i, a),
        t.pv = t.dpv = Yt(a, i)
    }
    , function(t) {
        var r = t.stack
    ...
    , function(t) {
        t.fv = t.pv,
        e.DEBUG && console.log(t.step, "SFVTPV[]")
    }
    , function(t) {
        var r = t.stack
          , i = r.pop()
    ...
    , function(t) {
        var r = t.stack.pop();
        switch (e.DEBUG && console.log(t.step, "SZP0[]", r),
        t.zp0 = r,
        r) {
        case 0:
            t.tZone || er(t),
    ...
    , function(t) {
        var r = t.stack.pop();
        switch (e.DEBUG && console.log(t.step, "SZP1[]", r),
        t.zp1 = r,
        r) {
        case 0:
            t.tZone || er(t),
    ...
    , function(t) {
        var r = t.stack.pop();
        switch (e.DEBUG && console.log(t.step, "SZP2[]", r),
        t.zp2 = r,
        r) {
        case 0:
            t.tZone || er(t),
    ...
    , function(t) {
        var r = t.stack.pop();
        switch (e.DEBUG && console.log(t.step, "SZPS[]", r),
        t.zp0 = t.zp1 = t.zp2 = r,
        r) {
        case 0:
            t.tZone || er(t),
    ...
    , function(t) {
        e.DEBUG && console.log(t.step, "RTG[]"),
        t.round = _t
    }
    , function(t) {
        e.DEBUG && console.log(t.step, "RTHG[]"),
        t.round = Gt
    }
    , function(t) {
        var r = t.stack.pop();
        e.DEBUG && console.log(t.step, "SMD[]", r),
        t.minDis = r / 64
    }
    , function(t) {
        e.DEBUG && console.log(t.step, "ELSE[]"),
        tr(t, !1)
    }
    , function(t) {
        var r = t.stack.pop();
        e.DEBUG && console.log(t.step, "JMPR[]", r),
        t.ip += r - 1
    }
    , function(t) {
        var r = t.stack.pop();
        e.DEBUG && console.log(t.step, "SCVTCI[]", r),
        t.cvCutIn = r / 64
    }
    , void 0, void 0, function(t) {
        var r = t.stack;
        e.DEBUG && console.log(t.step, "DUP[]"),
        r.push(r[r.length - 1])
    }
    , or, function(t) {
        e.DEBUG && console.log(t.step, "CLEAR[]"),
        t.stack.length = 0
    }
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "SWAP[]"),
        r.push(i),
        r.push(a)
    }
    , function(t) {
        var r = t.stack;
        e.DEBUG && console.log(t.step, "DEPTH[]"),
        r.push(r.length)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop();
        e.DEBUG && console.log(t.step, "CINDEX[]", i),
        r.push(r[r.length - i])
    }
    , function(t) {
        var r = t.stack
        ...
        r.push(r.splice(r.length - i, 1)[0])
    }
    , void 0, void 0, void 0, function(t) {
        ...
        for (var o = 0; o < a; o++)
            Ut(t),
            e.DEBUG && console.log(++t.step, o + 1 < a ? "next loopcall" : "done loopcall", o);
        t.ip = s,
        t.prog = n
    }
    , function(t) {
    ...
    , function(t) {
        ...
        for (e.DEBUG && console.log(t.step, "FDEF[]", s); 45 !== i[++a]; )
            ;
        t.ip = a,
        t.funcs[s] = i.slice(n + 1, a)
    }
    , void 0, pr.bind(void 0, 0), pr.bind(void 0, 1), lr.bind(void 0, Wt), lr.bind(void 0, qt), hr.bind(void 0, 0), hr.bind(void 0, 1), cr.bind(void 0, 0), cr.bind(void 0, 1), ur.bind(void 0, 0), ur.bind(void 0, 1), function(t) {
        for (var r = t.stack, i = t.loop, a = t.fv, s = r.pop() / 64, n = t.z2; i--; ) {
            var o = r.pop()
              , p = n[o];
            e.DEBUG && console.log(t.step, (t.loop > 1 ? "loop " + (t.loop - i) + ": " : "") + "SHPIX[]", o, s),
            a.setRelative(p, p, s),
            a.touch(p)
        }
        t.loop = 1
    ...
    , function(t) {
        for (var r = t.stack, i = t.rp1, a = t.rp2, s = t.loop, n = t.z0[i], o = t.z1[a], p = t.fv, l = t.dpv, h = t.z2; s--; ) {
            var c = r.pop()
              , u = h[c];
            e.DEBUG && console.log(t.step, (t.loop > 1 ? "loop " + (t.loop - s) + ": " : "") + "IP[]", c, i, "<->", a),
            p.interpolate(u, n, o, l),
            p.touch(u)
        }
        t.loop = 1
    }
    , dr.bind(void 0, 0), dr.bind(void 0, 1), function(t) {
        for (var r = t.stack, i = t.rp0, a = t.z0[i], s = t.loop, n = t.fv, o = t.pv, p = t.z1; s--; ) {
            var l = r.pop()
              , h = p[l];
            e.DEBUG && console.log(t.step, (t.loop > 1 ? "loop " + (t.loop - s) + ": " : "") + "ALIGNRP[]", l),
    ...
    , function(t) {
        e.DEBUG && console.log(t.step, "RTDG[]"),
        t.round = Ft
    }
    , fr.bind(void 0, 0), fr.bind(void 0, 1), function(t) {
        var r = t.prog
          , i = t.ip
          , a = t.stack
          , s = r[++i];
    ...
    , function(t) {
        ...
        var a = r.pop()
          , s = r.pop();
        e.DEBUG && console.log(t.step, "WS", a, s),
        i[s] = a
    }
    , function(t) {
        var r = t.stack
    ...
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "WCVTP", i, a),
        t.cvt[a] = i / 64
    }
    , function(t) {
        var r = t.stack
          , i = r.pop();
        e.DEBUG && console.log(t.step, "RCVT", i),
        r.push(64 * t.cvt[i])
    }
    , mr.bind(void 0, 0), mr.bind(void 0, 1), void 0, yr.bind(void 0, 0), yr.bind(void 0, 1), function(t) {
        e.DEBUG && console.log(t.step, "MPPEM[]"),
        t.stack.push(t.ppem)
    }
    , void 0, function(t) {
        e.DEBUG && console.log(t.step, "FLIPON[]"),
        t.autoFlip = !0
    }
    , void 0, void 0, function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "LT[]", i, a),
        r.push(a < i ? 1 : 0)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "LTEQ[]", i, a),
        r.push(a <= i ? 1 : 0)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "GT[]", i, a),
        r.push(a > i ? 1 : 0)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "GTEQ[]", i, a),
        r.push(a >= i ? 1 : 0)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "EQ[]", i, a),
        r.push(i === a ? 1 : 0)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "NEQ[]", i, a),
        r.push(i !== a ? 1 : 0)
    }
    , function(t) {
        var r = t.stack
        ...
        r.push(Math.trunc(i) % 2 ? 1 : 0)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop();
        e.DEBUG && console.log(t.step, "EVEN[]", i),
        r.push(Math.trunc(i) % 2 ? 0 : 1)
    }
    , function(t) {
        var r = t.stack.pop();
    ...
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "AND[]", i, a),
        r.push(i && a ? 1 : 0)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "OR[]", i, a),
        r.push(i || a ? 1 : 0)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop();
        e.DEBUG && console.log(t.step, "NOT[]", i),
        r.push(i ? 0 : 1)
    }
    , gr.bind(void 0, 1), function(t) {
        var r = t.stack.pop();
        e.DEBUG && console.log(t.step, "SDB[]", r),
        t.deltaBase = r
    }
    , function(t) {
        var r = t.stack.pop();
        e.DEBUG && console.log(t.step, "SDS[]", r),
        t.deltaShift = Math.pow(.5, r)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "ADD[]", i, a),
        r.push(a + i)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "SUB[]", i, a),
        r.push(a - i)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "DIV[]", i, a),
        r.push(64 * a / i)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "MUL[]", i, a),
        r.push(a * i / 64)
    }
    , function(t) {
        var r = t.stack
          , i = r.pop();
        e.DEBUG && console.log(t.step, "ABS[]", i),
        r.push(Math.abs(i))
    }
    , function(t) {
        var r = t.stack
          , i = r.pop();
        e.DEBUG && console.log(t.step, "NEG[]", i),
        r.push(-i)
    }
    , function(t) {
        var r = t.stack
        ...
        r.push(64 * Math.floor(i / 64))
    }
    , function(t) {
        var r = t.stack
          , i = r.pop();
        e.DEBUG && console.log(t.step, "CEILING[]", i),
        r.push(64 * Math.ceil(i / 64))
    }
    , vr.bind(void 0, 0), vr.bind(void 0, 1), vr.bind(void 0, 2), vr.bind(void 0, 3), void 0, void 0, void 0, void 0, function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "WCVTF[]", i, a),
        t.cvt[a] = i * t.ppem / t.font.unitsPerEm
    }
    , gr.bind(void 0, 2), gr.bind(void 0, 3), br.bind(void 0, 1), br.bind(void 0, 2), br.bind(void 0, 3), function(t) {
        var r, i = t.stack.pop();
        switch (e.DEBUG && console.log(t.step, "SROUND[]", i),
        t.round = zt,
        192 & i) {
        case 0:
            r = .5;
        ...
        i &= 15,
        t.srThreshold = 0 === i ? 0 : (i / 8 - .5) * r
    }
    , function(t) {
        var r, i = t.stack.pop();
        switch (e.DEBUG && console.log(t.step, "S45ROUND[]", i),
        t.round = zt,
        192 & i) {
        case 0:
            r = Math.sqrt(2) / 2;
    ...
    , void 0, void 0, function(t) {
        e.DEBUG && console.log(t.step, "ROFF[]"),
        t.round = Bt
    }
    , void 0, function(t) {
        e.DEBUG && console.log(t.step, "RUTG[]"),
        t.round = Vt
    }
    , function(t) {
        e.DEBUG && console.log(t.step, "RDTG[]"),
        t.round = Ht
    }
    , or, or, void 0, void 0, void 0, void 0, void 0, function(t) {
        var r = t.stack.pop();
        e.DEBUG && console.log(t.step, "SCANCTRL[]", r)
    }
    , xr.bind(void 0, 0), xr.bind(void 0, 1), function(t) {
        var r = t.stack
          , i = r.pop()
          , a = 0;
    ...
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "MAX[]", i, a),
        r.push(Math.max(a, i))
    }
    , function(t) {
        var r = t.stack
          , i = r.pop()
          , a = r.pop();
        e.DEBUG && console.log(t.step, "MIN[]", i, a),
        r.push(Math.min(a, i))
    }
    , function(t) {
        var r = t.stack.pop();
    ...
    , function(t) {
        var r = t.stack.pop()
          , i = t.stack.pop();
        switch (e.DEBUG && console.log(t.step, "INSTCTRL[]", r, i),
        r) {
        case 1:
    ...
    Zr.prototype.replaceRange = function(e, t, r, i) {
        ...
        if (!isNaN(e) && this.inboundIndex(e) && a) {
            ...
            return i || this.dispatch("replaceToken", [e, t, r]),
            [s, r]
        }
        return {
    ...
    Zr.prototype.replaceToken = function(e, t, r) {
        if (!isNaN(e) && this.inboundIndex(e) && t instanceof Er) {
            ...
            return r || this.dispatch("replaceToken", [e, t]),
            [i[0], t]
        }
        return {
    ...
    Zr.prototype.removeRange = function(e, t, r) {
        ...
        return r || this.dispatch("removeRange", [i, e, t]),
        i
    }
    ,
    Zr.prototype.removeToken = function(e, t) {
        if (!isNaN(e) && this.inboundIndex(e)) {
            ...
            return t || this.dispatch("removeToken", [r, e]),
            r
        }
        return {
    ...
    Zr.prototype.dispatch = function(e, t) {
        var r = this
          , i = this.events[e];
        i instanceof Or && i.subscribers.forEach(function(e) {
            e.apply(r, t || [])
        })
    }
    ,
    Zr.prototype.registerContextChecker = function(e, t, r) {
        ...
        (e,t,r);
        return this.registeredContexts[e] = i,
        this.contextCheckers.push(i),
        i
    }
    ,
    ...
    Zr.prototype.runContextCheck = function(e) {
        ...
        this.contextCheckers.forEach(function(i) {
            ...
            if (!s && i.checkStart(e) && (s = new Tr(r,null,a),
    ...
    Zr.prototype.tokenize = function(e) {
        ...
        for (var r = 0; r < t.length; r++) {
            var i = t[r]
              , a = new kr(t,r);
            this.dispatch("next", [a]),
            this.runContextCheck(a);
            var s = new Er(i);
            this.tokens.push(s),
            this.dispatch("newToken", [s, a])
        }
        return this.dispatch("end", [this.tokens]),
        this.tokens
    }
    ;
    var Lr = {
    ...
    function Ar() {
        var e = this;
        this.features.hasOwnProperty("arab") && (this.features.arab.hasOwnProperty("rlig") && (jr.call(this),
    ...
    Ir.prototype.processText = function(e) {
        this.text && this.text === e || (this.setText(e),
        function() {
            return function() {
        ...
        function() {
            var e = this;
            this.features.hasOwnProperty("arab") && (jr.call(this),
            this.tokenizer.getContextRanges("arabicWord").forEach(function(t) {
                Ur.call(e, t)
            }))
        }
    ...
    function Vr(e, t, r) {
        ...
        r.hasOwnProperty("inputCoverage") && (this.inputCoverage = r.inputCoverage.map(function(e) {
            return new Fr(e)
        })),
        r.hasOwnProperty("backtrackCoverage") && (this.backtrackCoverage = r.backtrackCoverage.map(function(e) {
            return new Fr(e)
        })),
        r.hasOwnProperty("lookaheadCoverage") && (this.lookaheadCoverage = r.lookaheadCoverage.map(function(e) {
            return new Fr(e)
        })),
    ...
    function Wr(e) {
        (e = e || {}).empty || (Ot(e.familyName, "When creating a new Font object, familyName is required."),
    ...
    function Qr(e, t, r, i) {
        var a = {}
          , s = new se.Parser(e,t);
        a.name = i[s.parseUShort()] || {},
        s.skip("uShort", 1),
        a.coordinates = {};
        for (var n = 0; n < r.length; ++n)
            a.coordinates[r[n].tag] = s.parseFixed();
        return a
    }
    Gr.prototype.lookup = function(e, t) {
        for (var r = this.ligatureSets[t], i = function(e, t) {
            if (e.length > t.length)
                return null;
        ...
        if (6 === r && 3 === i) {
            var s = function(e) {
                ...
                if (e.lookahead.length < this.lookaheadCoverage.length)
                    return [];
                for (var a = e.lookahead.slice(i); a.length && Nr(a[0].char); )
                    a.shift();
                var s = new kr(a,0)
                  , n = qr(this.lookaheadCoverage, s)
                  , o = [].concat(e.backtrack);
                for (o.reverse(); o.length && Nr(o[0].char); )
                    o.shift();
                if (o.length < this.backtrackCoverage.length)
                    return [];
                var p = new kr(o,0)
                  , l = qr(this.backtrackCoverage, p)
                  , h = [];
                if (r.length === this.inputCoverage.length && n.length === this.lookaheadCoverage.length && l.length === this.backtrackCoverage.length)
        ...
        for (var t = this.font.tables.gsub.scripts, r = 0; r < t.length; r++) {
            ...
            if (a)
                for (var s = 0; s < a.length; s++) {
                    var n = a[s];
                    if (n.tag === e)
                        return n.langSys.featureIndexes
                }
        }
        return []
    }
    ...
    Br.prototype.getFeature = function(e) {
        return this.font ? (this.features.hasOwnProperty(e.script) || this.getScriptFeatures(e.script),
    ...
    Wr.prototype.stringToGlyphs = function(e, t) {
        ...
        var a = new Br(this);
        i.applyFeatures(["init", "medi", "fina", "rlig"].map(function(e) {
            var t = {
                tag: e,
                script: "arab"
            }
        ...
        if (t.features) {
            ...
            for (var l = 0; l < n; l += 1)
                for (var h = 0; h < p.length; h++) {
                    for (var c = p[h], u = c.sub, d = u.length, f = 0; f < d && u[f] === s[l + f]; )
                        f++;
                    f === d && (s.splice(l, d, c.by),
                    n = n - d + 1)
                }
        }
        for (var m = new Array(n), y = this.glyphs.get(0), g = 0; g < n; g += 1)
            m[g] = r.glyphs.get(s[g]) || y;
        return m
    }
    ,
    ...
    ,
    Wr.prototype.defaultRenderOptions = {
        kerning: !0,
        features: {
            liga: !0,
            rlig: !0
    ...
    Wr.prototype.forEachGlyph = function(e, t, r, i, a, s) {
        ...
        var n, o = 1 / this.unitsPerEm * i, p = this.stringToGlyphs(e, a);
        if (a.kerning) {
        ...
        for (var h = 0; h < p.length; h += 1) {
            var c = p[h];
            if (s.call(this, c, t, r, i, a),
            c.advanceWidth && (t += c.advanceWidth * o),
            a.kerning && h < p.length - 1)
                t += (n ? this.position.getKerningValue(n, c.index, p[h + 1].index) : this.getKerningValue(c, p[h + 1])) * o;
    ...
    var $r = {
        make: function(e, t) {
            ...
            for (var i = 0; i < e.axes.length; i++)
                r.fields = r.fields.concat(Yr(i, e.axes[i], t));
        ...
        parse: function(e, t, r) {
            ...
            i.skip("uShort", 1);
            for (var n = i.parseUShort(), o = i.parseUShort(), p = i.parseUShort(), l = i.parseUShort(), h = [], c = 0; c < n; c++)
                h.push(Jr(e, t + s + c * o, r));
            for (var u = [], d = t + s + n * o, f = 0; f < p; f++)
                u.push(Qr(e, d + f * l, h, r));
            return {
                axes: h,
                instances: u
            }
    ...
    ei[2] = function() {
        ...
        if (1 === t)
            return {
                ...
                valueFormat1: i,
                valueFormat2: a,
                pairSets: this.parseList(ie.pointer(ie.list(function() {
                    return {
        ...
        if (2 === t) {
            ...
            return {
                ...
                class1Count: o,
                class2Count: p,
                classRecords: this.parseList(o, ie.list(p, function() {
                    return {
                        value1: this.parseValueRecord(i),
                        value2: this.parseValueRecord(a)
                    }
    ...
    var ri = {
        parse: function(e, t) {
            var r = new ie(e,t = t || 0)
              , i = r.parseVersion(1);
            return C.argument(1 === i || 1.1 === i, "Unsupported GPOS table version " + i),
            1 === i ? {
                version: i,
                scripts: r.parseScriptList(),
                features: r.parseFeatureList(),
        ...
        make: function(e) {
            return new K.Table("GPOS",[{
                ...
                name: "lookups",
                type: "TABLE",
                value: new K.LookupList(e.lookups,ti)
            }])
        }
    };
    var ii = {
    ...
    var ai = {
        parse: function(e, t, r, i) {
            for (var a = new se.Parser(e,t), s = i ? a.parseUShort : a.parseULong, n = [], o = 0; o < r + 1; o += 1) {
                var p = s.call(a);
                i && (p *= 2),
                n.push(p)
            }
    ...
    function li(e) {
        var t, r, i, a, s, n, o, p, l, h, c, u, d, f, m = new Wr({
            empty: !0
        }), y = new DataView(e,0), g = [], v = se.getTag(y, 0);
        if (v === String.fromCharCode(0, 1, 0, 0) || "true" === v || "typ1" === v)
            m.outlinesFormat = "truetype",
            g = oi(y, i = se.getUShort(y, 4));
        else if ("OTTO" === v)
            m.outlinesFormat = "cff",
            g = oi(y, i = se.getUShort(y, 4));
        else {
            if ("wOFF" !== v)
                throw new Error("Unsupported OpenType signature " + v);
            var b = se.getTag(y, 4);
            if (b === String.fromCharCode(0, 1, 0, 0))
                m.outlinesFormat = "truetype";
            else {
                if ("OTTO" !== b)
                    throw new Error("Unsupported OpenType flavor " + v);
                m.outlinesFormat = "cff"
            }
            g = function(e, t) {
        ...
        for (var x = 0; x < i; x += 1) {
            ...
            case "OS/2":
                w = pi(y, P),
                m.tables.os2 = st.parse(w.data, w.offset);
                break;
            case "post":
                w = pi(y, P),
        ...
        var S = pi(y, u);
        if (m.tables.name = it.parse(S.data, S.offset, r),
        ...
        var R = pi(y, l);
        if (Ge.parse(R.data, R.offset, m.numberOfHMetrics, m.numGlyphs, m.glyphs),
        function(e) {
            ...
            for (var o = 0; o < e.glyphs.length; o += 1)
                t = e.glyphs.get(o),
                e.cffEncoding ? e.isCIDFont ? t.name = "gid" + o : t.name = e.cffEncoding.charset[o] : e.glyphNames.names && (t.name = e.glyphNames.glyphIndexToName(o))
        }(m),
        h) {
            var C = pi(y, h);
        ...
        if (o) {
            var N = pi(y, o);
            m.tables.gpos = ri.parse(N.data, N.offset),
            m.position.init()
        }
        if (p) {
            var L = pi(y, p);
        ...
        if (d) {
            var U = pi(y, d);
            m.tables.meta = ct.parse(U.data, U.offset),
...
function(e) {
    ...
    var r = {
        ...
        getFn: function e(t, r, i) {
            ...
            var h;
            if (r) {
                if (-1 !== (o = r.indexOf(".")) ? (s = r.slice(0, o),
                n = r.slice(o + 1)) : s = r,
                null !== (p = t[s]) && void 0 !== p)
    ...
    function i(e, t) {
        var i;
        for (i in this.list = e,
        this.options = t = t || {},
        r)
            r.hasOwnProperty(i) && ("boolean" == typeof r[i] ? this.options[i] = i in t ? t[i] : r[i] : this.options[i] = t[i] || r[i])
    }
    function a(e) {
    ...
    i.prototype._prepareSearchers = function() {
        ...
        if (this.options.tokenize)
            for (this.tokenSearchers = []; a < s; a++)
                this.tokenSearchers.push(new r(i[a],e));
        this.fullSeacher = new r(t,e)
    }
    ,
    i.prototype._startSearch = function() {
        var e, t, r, i, a = this.options.getFn, s = this.list, n = s.length, o = this.options.keys, p = o.length, l = null;
        if ("string" == typeof s[0])
            for (r = 0; r < n; r++)
                this._analyze("", s[r], r, r);
        else
            for (this._keyMap = {},
            r = 0; r < n; r++)
                for (l = s[r],
    ...
    i.prototype._analyze = function(e, r, i, s) {
        var n, o, p, l, h, c, u, d, f, m, y, g, v, b, x, P = this.options, w = !1;
        if (void 0 !== r && null !== r) {
            o = [];
            var S = 0;
            if ("string" == typeof r) {
                if (n = r.split(P.tokenSeparator),
                P.verbose && t("---------\nKey:", e),
                this.options.tokenize) {
                    for (b = 0; b < this.tokenSearchers.length; b++) {
                        ...
                        x = 0; x < n.length; x++) {
                            m = n[x];
                            var E = {};
                            (y = d.search(m)).isMatch ? (E[m] = y.score,
                            w = !0,
                            g = !0,
                            o.push(y.score)) : (E[m] = 1,
                            this.options.matchAllTokens || o.push(1)),
                            f.push(E)
                        }
                        g && S++,
                        P.verbose && t("Token scores:", f)
                    }
                    for (l = o[0],
                    c = o.length,
                    b = 1; b < c; b++)
                        l += o[b];
                    l /= c,
                    P.verbose && t("Token score average:", l)
                }
                ...
                (w || u.isMatch) && v && ((p = this.resultMap[s]) ? p.output.push({
                    key: e,
                    score: h,
                ...
                for (b = 0; b < r.length; b++)
                    this._analyze(e, r[b], i, s)
        }
    }
    ,
    i.prototype._computeScore = function() {
        var e, r, i, a, s, n, o, p, l = this._keyMap, h = this.results;
        for (this.options.verbose && t("\n\nComputing score:\n"),
        e = 0; e < h.length; e++) {
            for (i = 0,
            s = (a = h[e].output).length,
            o = 1,
            r = 0; r < s; r++)
                p = a[r].score * (n = l ? l[a[r].key].weight : 1),
                1 !== n ? o = Math.min(o, p) : (i += p,
                a[r].nScore = p);
            h[e].score = 1 === o ? i / s : o,
            this.options.verbose && t(h[e])
        }
    }
    ,
    ...
    i.prototype._format = function() {
        var e, r, i, a, s, n = this.options, o = n.getFn, p = [], l = this.results, h = n.include;
        for (n.verbose && t("\n\nOutput:\n\n", l),
        a = n.id ? function(e) {
    ...
    s.prototype.search = function(e) {
        var t, r, i, a, s, n, o, p, l, h, c, u, d, f, m, y, g, v, b, x, P, w, S, E = this.options;
        if (e = E.caseSensitive ? e : e.toLowerCase(),
        this.pattern === e)
            return {
                isMatch: !0,
                score: 0,
        ...
        t = 0; t < i; t++)
            x[t] = 0;
        for (-1 != o && (n = Math.min(this._bitapScore(0, o), n),
        -1 != (o = e.lastIndexOf(this.pattern, s + this.patternLen)) && (n = Math.min(this._bitapScore(0, o), n))),
        o = -1,
        y = 1,
        g = [],
        h = this.patternLen + i,
        t = 0; t < this.patternLen; t++) {
            for (p = 0,
            l = h; p < l; )
                this._bitapScore(t, s + l) <= n ? p = l : h = l,
                l = Math.floor((h - p) / 2 + p);
            for (h = l,
            c = Math.max(1, s - l + 1),
            u = a ? i : Math.min(s + l, i) + this.patternLen,
            (d = Array(u + 2))[u + 1] = (1 << t) - 1,
            r = u; r >= c; r--)
                if ((m = this.patternAlphabet[e.charAt(r - 1)]) && (x[r - 1] = 1),
            ...
            if (this._bitapScore(t + 1, s) > n)
                break;
            f = d
        }
        return P = this._getMatchedIndices(x),
        {
            isMatch: o >= 0,
            score: 0 === y ? .001 : y,
            matchedIndices: P
    ...
    s.prototype._getMatchedIndices = function(e) {
        for (var t, r = [], i = -1, a = -1, s = 0, n = e.length; s < n; s++)
            (t = e[s]) && -1 === i ? i = s : t || -1 === i || ((a = s - 1) - i + 1 >= this.options.minMatchCharLength && r.push([i, a]),
            i = -1);
        return e[s - 1] && s - 1 - i + 1 >= this.options.minMatchCharLength && r.push([i, s - 1]),
        r
    }
    ,
    ...
    Object.defineProperty(this, "sequence", {
        set: function(e) {
            ...
            i._sequence.properties.resolution.onChanged.watch(function() {
                ...
                i.camera = new THREE.OrthographicCamera(.5 * -e[0],.5 * e[0],.5 * e[1],.5 * -e[1],0,1)
            }, !0)
        }
    }),
    this.copyPass = new THREE.ShaderPass(new THREE.ShaderMaterial({
        uniforms: THREE.UniformsUtils.clone(THREE.CopyShader.uniforms),
        fragmentShader: THREE.CopyShader.fragmentShader,
        vertexShader: THREE.CopyShader.vertexShader
    })),
...
PZ.compositor.prototype = {
    ...
    renderSequence: function(e) {
        ...
        for (var t = this._sequence.videoTracks, r = 0; r < t.length; r++) {
            t[r].skip = !0;
            let e = t[r].layer;
            e && (e instanceof PZ.layer.scene && !e.pass.camera || e instanceof PZ.layer.composite && !e.objects.length || (t[r].skip = !1,
            0))
        }
        ...
        for (var s = 0; s < i; s++) {
            ...
            for (r = 0; r < t.length; r++) {
                ...
                this.renderLayer(n, 0, !1)
            }
            this.mixPass.render(this.renderer, this.accumBuffers[1], this.accumBuffers[0], this.screenBuffers[0], !0),
        ...
        this.copyPass.render(this.renderer, null, null, !0),
        this.copyPass.uniforms.opacity.value = 1
    },
    renderEffects: function(e, t, r) {
        console.assert(!!e);
        let i, a, s, n = e.length;
        for (s = 0; s < n; s++)
            (i = e[s])instanceof PZ.effect.group ? i.enabled && this.renderEffects(i.objects, t, r) : (a = i.pass) && a.enabled && (a.uniforms.uvScale && a.uniforms.uvScale.value.set(t, r),
            a.render(this.renderer, this.writeBuffer, this.readBuffer, !0),
            a.needsSwap && this.swapBuffers())
    },
    renderLayer: function(e, t, r) {
        let i = this.screenBuffers[t]
          , a = (e.composite.scene,
        e.properties.resolution.get())
          , s = Math.min(Math.ceil(a[0] * this.ratio), i.width)
          , n = Math.min(Math.ceil(a[1] * this.ratio), i.height);
        var o = s / i.width
          , p = n / i.height;
        if (this.readBuffer.viewport.set(0, 0, s, n),
        e.texture instanceof THREE.Texture)
            ...
            this.copyPass.render(this.renderer, this.readBuffer, i, !0);
            ...
            this.copyPass.render(this.renderer, this.readBuffer, null, !0),
            ISNODE && (this.copyPass.uniforms.uvOffset.value.set(0, 0),
            this.copyPass.uniforms.uvScale.value.set(1, 1))
        } else if (e instanceof PZ.layer.composite) {
            this.screenBuffers[t + 1] || (this.screenBuffers[t + 1] = this.readBuffer.clone()),
            this.clear(t + 1);
            ...
            e.pass && (e.pass.uniforms,
            e.pass.render(this.renderer, this.readBuffer, null, !0));
        this.writeBuffer.viewport.set(0, 0, s, n),
        this.renderEffects(e.effects, o, p),
        e.composite.quad.material.uniforms && e.composite.quad.material.uniforms.tDiffuse && (e.composite.quad.material.uniforms.tBG.value = i.texture,
    ...
    compositeScene: function(e, t) {
        for (this.scene.background = t.texture,
        this.writeBuffer.viewport.set(0, 0, t.width, t.height),
        this.renderer.render(this.scene, this.camera, e ? null : this.writeBuffer, !0); this.scene.children[0]; )
    ...
    reset: function(e, t) {
        ...
        this.canvasTexture.generateMipmaps = !1) : (this.canvas = document.createElement("canvas"),
        this.canvas.width = e,
    ...
    unload: function() {
        this.readBuffer && this.readBuffer.dispose(),
        this.writeBuffer && this.writeBuffer.dispose();
        for (let e = 0; e < this.screenBuffers.length; e++)
            this.screenBuffers[e] && this.screenBuffers[e].dispose();
        this.canvas = null
    }
},
THREE.Pass = function() {
...
PZ.schedule = function(e) {
    0 === e ? (ISNODE ? this.texture = new THREE.DataTexture : (this.el = document.createElement("video"),
    ...
    this.playing = !1,
    this.padding = 60,
    this.type = 0) : 1 === e ? (ISNODE || (this.el = document.createElement("audio"),
    this.el.preload = "auto"),
    this.playing = !1,
    this.padding = 60,
    this.type = 1) : (this.el = null,
    this.padding = 0,
    this.type = 2),
    this.reset()
}
...
PZ.schedule.prototype.reset = function() {
    this.el && this.playing && (this.el.pause(),
    this.playing = !1),
    ...
    if (!r || r.start + r.length <= e || r.start - this.padding > e) {
        ...
        if (i.start + i.length <= e)
            for (var a = this.index; ++a < this.items.length; ) {
                if (e < this.items[a].start - this.padding)
                    break;
                this.index = a
            }
        else if (i.start > e)
            for (a = this.index; --a >= 0; ) {
                var s = this.items[a];
                if (e >= s.start + s.length)
                    break;
                this.index = a
            }
        (i = this.items[this.index]).start - this.padding <= e && i.start + i.length > e ? (this.currentItem = i,
        this.el && (this.el.src = this.currentItem.media.url,
        this.el.currentTime = this.currentItem.clip.properties.time.get(0)),
        this.texture && (this.currentItem.texture = this.texture)) : this.currentItem = null
    }
}
,
...
PZ.schedule.prototype.ffDecodeFrame = function(e, t) {
    ...
    if (this.decoder && r === this.decoder.filename && e === this.decoder.lastFrame + 1)
        ...
        this.decoder.nextFrameData && (i.image.data.set(this.decoder.nextFrameData),
        this.decoder.frameByteOffset += this.decoder.nextFrameData.length,
        this.decoder.nextFrameData = null);
    else {
        this.decoder && this.decoder.process ? (this.decoder.process.kill(),
        this.decoder.process = null) : this.decoder = {};
        var a = ["-ss", (e / t).toFixed(3), "-i", r, "-r", t, ..."-vf vflip -f rawvideo -pix_fmt rgb24 -".split(" ")];
    ...
    return new Promise(async function(e, t) {
        if (!s.decoder.process)
            return console.log("video process not running"),
            s.decoder = null,
            void e();
        let r = setTimeout(()=>{
        ...
        , 15e3)
          ...
          , n = t=>{
            ...
            s.decoder.frameByteOffset >= o && (s.decoder.process.stdout.pause(),
        ...
        ;
        s.decoder.process.on("exit", a),
        s.decoder.process.stdout.on("data", n),
        s.decoder.process.stdout.resume()
    }
    )
}
,
PZ.schedule.prototype.prepare = async function(e, t) {
    ...
    this.currentItem) {
        ...
        this.currentItem.clip && (this.currentItem.clip.update(e),
        await this.currentItem.clip.prepare(e, t))
    }
}
,
PZ.schedule.combineTracks = function(e) {
    for (var t = [], r = 0; r < e.length; r++)
        0 !== e[r].clips.length && t.push({
            track: e[r],
            idx: 0
        });
    var i, a = [];
    function s() {
        for (var e = 0, r = null, i = 0; i < t.length; i++) {
            ...
            (!r || s.start < r.start) && (r = s,
            e = i)
        }
        return null !== r && ++t[e].idx >= t[e].track.clips.length && t.splice(e, 1),
        r
    }
    for (; i = s(); )
        a.push(i);
...
PZ.schedule.cleanUpSchedules = function(e, t) {
    for (var r = t.length - 1; r >= 0; r--)
        if (0 === t[r].items.length) {
            ...
            i.unload(),
            e.ui.onScheduleUnloaded.update(i)
        } else
            t[r].currentItem = null
}
,
    ...
    for (a = 0; a < t.length; a++)
        if (t[a].canAdd(i)) {
            var s = t[a].currentItem
              , n = t[a].padding;
            if (null === s || s.start + s.length <= r.start - n)
                break
        }
    t[a] || (t[a] = new PZ.schedule(i),
    e.ui.onScheduleCreated.update(t[a])),
    t[a].items.push(r),
    t[a].currentItem = r
}
,
...
PZ.export = function(e, t, r) {
    ...
    ISNODE) {
        ...
        console.log("GPU: " + i),
        "Mesa DRI Intel(R) HD Graphics 500 (Broxton 2x6)" === i.trim() && (console.warn("Broken config detected: using readPixels workaround"),
    ...
    this.renderer && (this.renderer.setSize(t.width, t.height, !1),
    this.renderer.setClearColor(0, 1),
...
PZ.export.prototype.unload = function() {
    this.compositor && (this.compositor.unload(),
...
PZ.export.prototype.remuxAudio = async function(e) {
    var t = {
        file: {
            name: e.media.filename || "audio.ogg",
            data: e.media.file
        },
        startTime: e.offset,
        duration: e.length,
    ...
    return e.startOffset = Math.max(e.offset - r.offset, 0),
    r.buffer
}
,
PZ.export.prototype.decodeAudio = function(e) {
    return new Promise(function(t, r) {
        var i = e.slice(0)
          , a = new AudioContext;
        a.decodeAudioData(e, function(e) {
            a.close(),
            t(e)
        }, function(e) {
...
PZ.export.prototype.ffDecodeAudio = function(e) {
    ...
    new Promise(function(r, a) {
        let s = ["-i", i, "-ss", t.toFixed(3), ..."-acodec pcm_f32le -ac 2 -f f32le -ar 48000 -".split(" ")]
          ...
          , p = 0
          , l = setTimeout(()=>{
            console.log("audio decoder timed out"),
            n.kill(),
            r()
        }
        , 3e4);
...
PZ.export.prototype.renderAudioSegment = function(e, t, r) {
    ...
    return new Promise(function(t, o) {
        for (var p = new OfflineAudioContext(2,r,a), l = null; l = e.pop(); ) {
            ...
            h.buffer = l.buffer,
            h.playbackRate.value = l.playbackRate;
            let e = p.createGain()
...
,
ISNODE && (PZ.export.prototype.renderAudioSegment = function(e, t, r) {
    ...
    function o(t, r) {
        ...
        if ((r = Math.floor(r * i.playbackRate)) < 0 || r >= i.numSamples)
            return [0, 0];
        let l = o[2 * r]
          , h = o[2 * r + 1]
          , c = i.volume.get(p);
...
PZ.export.prototype.getAudioSamples = async function(e) {
    if (this.samplesRendered >= this.totalSamples)
    ...
    return this.samplesRendered += r,
    this.sample += r,
    await this.renderAudioSegment(i, t, r)
}
,
PZ.export.prototype.getVideoFrame = async function(e) {
    if (this.framesRendered >= this.totalFrames)
        return 0;
    if (this.frameWaiting !== Math.round(this.frame) && (this.frameWaiting = Math.round(this.frame),
    ...
    this.frameWaiting !== Math.round(this.frame) && (this.frameWaiting = Math.round(this.frame),
    this.framePromise = this.sequence.prepare(this.frameWaiting, this)),
    1
}
,
...
PZ.upload.prototype.fetchWithRetry = async function(e, t, r) {
    ...
    for (void 0 === r && (r = 5); ; ) {
        ...
        if (i && i.ok)
            return i;
        if (i && i.status < 500 || a >= r)
            throw new Error(i.statusText);
        await this.sleep(100 * Math.pow(2, a)),
        a += 1
    }
}
,
PZ.upload.prototype.uploadFile = async function(e, t) {
    for (var r, i, a = Math.ceil(e.size / 262144), s = [], n = 0; n < a; n++) {
        ...
        s.push(btoa((r = n,
        (r += "").length >= (i = 10) ? r : new Array(i - r.length + 1).join("0") + r))),
    ...
    for (n = 0; n < a; n++)
        o += "<Uncommitted>" + s[n] + "</Uncommitted>";
    var p;
    o += "</BlockList>",
    (p = new Headers).append("Date", (new Date).toUTCString()),
    p.append("Content-Type", "text/plain; charset=UTF-8"),
    await this.fetchWithRetry(t + "&comp=blocklist", {
        method: "put",
        headers: p,
        body: o
    })
...
PZ.upload.prototype.uploadProject = async function(e, t) {
    ...
    for (let t = 0; t < r.length; t++) {
        ...
        a.source !== PZ.asset.source.FILE || a.references <= 0 || !a.file || (i.push(a),
        this.uploadSize += a.file.size)
    }
    ...
    let n = await this.fetchWithRetry(PZ.apiOrigin + "/renders/" + t + "/project", {
        credentials: "include"
    })
      , o = await n.text();
...
,
PZ.motionBlur.prototype.vertexShader = ["uniform mat4 prevModelViewMatrix;", "varying vec4 mvPosition;", "varying vec4 prevMvPosition;", "void main()", "{", "mvPosition = projectionMatrix * modelViewMatrix * vec4(position, 1.0);", "prevMvPosition = projectionMatrix * prevModelViewMatrix * vec4(position, 1.0);", "gl_Position = mvPosition;", "}"].join("\n"),
PZ.motionBlur.prototype.fragmentShader = ["varying vec4 mvPosition;", "varying vec4 prevMvPosition;", "void main()", "{", "vec2 a = (mvPosition.xy / mvPosition.w) * 0.5 + 0.5;", "vec2 b = (prevMvPosition.xy / prevMvPosition.w) * 0.5 + 0.5;", "vec2 velocity = 5.0 * (b - a);", "gl_FragColor = vec4(velocity.x, velocity.y, 0.1, 1.0);", "}"].join("\n"),
...
PZ.motionBlur.prototype.unload = function() {
    this.velocityBuffer && (this.velocityBuffer.dispose(),
    this.velocityBuffer = null)
}
,
PZ.motionBlur.prototype.getTexture = function() {
    return this.references <= 0 && (this.load(),
    this.references = 0),
    this.references += 1,
...
PZ.motionBlur.prototype.releaseTexture = function() {
    this.references -= 1,
    this.references <= 0 && (this.unload(),
    this.references = 0)
}
,
PZ.motionBlur.prototype.onBeforeRender = function(e, t, r, i, a, s) {
    if (!a.uniforms || !a.uniforms.prevModelViewMatrix)
        return;
...
PZ.motionBlur.prototype.update = function(e) {
    if (this.velocityBuffer) {
        for (let t = 0; t < this.layer.objects.length; t++)
            this.layer.objects[t].update(e + .5);
        this.scene.updateMatrixWorld(),
        this.scene.traverse(e=>{
            let t = this.prevModelViewMatrix.get(e);
            t || (t = new THREE.Matrix4,
            this.prevModelViewMatrix.set(t)),
...
PZ.motionBlur.prototype.render = function(e) {
    this.velocityBuffer && (this.scene.overrideMaterial = this.velocityShader,
    e.clearTarget(this.velocityBuffer, !0, !0, !0),
...
PZ.envMap.prototype.load = function() {
    this.mirrorCubeCamera = new THREE.CubeCamera(.1,5e3,256),
...
PZ.envMap.prototype.unload = function() {
    this.mirrorCubeCamera && (this.scene.remove(this.mirrorCubeCamera),
...
PZ.envMap.prototype.render = function(e) {
    this.mirrorCubeCamera && (e.autoClear = !0,
    this.mirrorCubeCamera.update(e, this.scene),
    e.autoClear = !1)
}
,
PZ.shake = function() {
...
PZ.shake.prototype.shake = function(e, t, r) {
    ...
    0 === this.properties.mode.get() ? (r.rotateX(this.getValue(e, i, a, s, n, o, 0) * t * .1),
    r.rotateY(this.getValue(e, i, a, s, n, o, 1) * t * .1)) : (r.translateX(this.getValue(e, i, a, s, n, o, 0) * t),
    r.translateY(this.getValue(e, i, a, s, n, o, 1) * t)),
    r.translateZ(this.getValue(e, i, a, s, n, o, 2) * t),
    r.rotateZ(this.getValue(e, i, a, s, n, o, 3) * t * .1)
}
,
...
PZ.asset.hash = async function(e) {
    return await new Promise(function(t, r) {
        ...
        i.onload = async function(e) {
            for (var r = await crypto.subtle.digest("SHA-256", new Uint8Array(e.target.result)), i = [], a = new Uint32Array(r), s = 0; s < a.length; s++) {
...
PZ.asset.prototype = {
    ...
    load: function(e, t) {
        e && (this.sha256 = e.sha256,
        this.url = e.url,
        this.source = e.source,
        this.external = e.external,
        this.size = e.size,
        this.filename = e.filename),
        e.file ? this.file = e.file : t && t.fileExists(this.sha256) && (this.file = t.getFileBlob(this.sha256)),
        this.file && (this.url = URL.createObjectURL(this.file))
    },
    toJSON: function(e) {
        return e === this.key ? {
            sha256: this.sha256,
            url: this.source !== PZ.asset.source.FILE ? this.url : void 0,
            source: this.source,
...
PZ.asset.image = class {
    constructor(e) {
        ...
        this.asset.data.set(PZ.asset.image, this.data))
    }
    get loading() {
    ...
    decodeBrowser() {
        ...
        this.data.loading = new Promise((e,t)=>{
            if (this.asset.url) {
                ...
                this.data.image.onload = e,
                this.data.image.src = t
            } else
                console.warn("Missing texture asset: " + (this.asset.filename || this.asset.sha256)),
                e()
        }
        )
    }
    decodeNode(e) {
        ...
        this.data.loading = new Promise(async(t,r)=>{
            ...
            await this.ffDecode(i, this.data.image, e),
            t()
        }
        )
    }
    async ffDecode(e, t, r) {
        await new Promise(function(i, a) {
            var s, n = ["-i", e, "-vf", "vflip" + (r ? ",scale=2^floor(log(iw)/log(2)):2^floor(log(ih)/log(2))" : ""), ..."-f rawvideo -pix_fmt rgba -".split(" ")], o = spawn(FFMPEG, n);
            let p = setTimeout(()=>{
                o.kill(),
                i()
            }
            ...
            o.stderr.on("data", function(e) {
                ...
                r && (t.width = parseInt(r[1]),
                t.height = parseInt(r[2]))
            })
        }
        )
    }
    getImage(e) {
        return this.data.image ? this.data.image : (ISNODE ? this.decodeNode(e) : this.decodeBrowser(),
        this.data.image)
    }
    getTexture(e) {
        var t, r = this.getImage(e);
        return ISNODE ? ((t = new THREE.DataTexture).image = r,
        t.magFilter = THREE.LinearFilter) : t = new THREE.Texture(r),
...
PZ.asset.font = class {
    ...
    async getFont() {
        return this.data.font2d ? this.data.font2d : (this.data.font2dLoading || (this.data.font2dLoading = new Promise(async(e,t)=>{
            var r = await this.readFile();
            this.data.font2d = opentype.parse(r),
            !0 === this.data.font2d.supported ? (this.data.font2d.familyName = this.data.font2d.getEnglishName("fontFamily").toLowerCase(),
            e(this.data.font2d)) : console.log("unsupported font")
        }
        )),
        await this.data.font2dLoading)
    }
    async get3DFont() {
        return this.data.font3d ? this.data.font3d : (this.data.font3dLoading || (this.data.font3dLoading = new Promise(async(e,t)=>{
            var r = await this.readFile();
            try {
    ...
    async readFile() {
        return this.asset.source === PZ.asset.source.FILE ? ISNODE || this.asset.file ? await this.readFileLocal() : await new Promise(()=>{}
        ) : await this.readFileRemote()
    }
    async readFileLocal() {
        return ISNODE ? await new Promise((e,t)=>{
...
PZ.asset.geometry = class {
    ...
    async getGeometry() {
        return this.data.geometry ? this.data.geometry : (this.data.loading || (this.data.loading = new Promise(async(e,t)=>{
            try {
                var r = await this.readFile()
                  , i = JSON.parse(r)
                  , a = new THREE.BufferGeometryLoader;
                this.data.geometry = a.parse(i),
                e(this.data.geometry)
            } catch (t) {
                console.error(t),
...
PZ.asset.av = class {
    constructor(e) {
        this.asset = e,
        this.asset.length = this.asset.length || Number.POSITIVE_INFINITY
    }
    get length() {
...
PZ.asset.shader = class {
    constructor(e) {
        ...
        this.asset.data.set(PZ.asset.shader, this.data))
    }
    get loading() {
        return this.data.loading
    }
    async getShader() {
        return this.data.shader ? this.data.shader : (this.data.loading || (this.data.loading = new Promise(async(e,t)=>{
            this.data.shader = await this.readFile(),
            e(this.data.shader)
        }
        )),
        await this.data.loading)
    ...
    async readFile() {
        return this.asset.source === PZ.asset.source.FILE ? await this.readFileLocal() : await this.readFileRemote()
    }
    async readFileLocal() {
        return ISNODE ? await new Promise((e,t)=>{
            fs.readFile(ASSETDIR + "/" + this.asset.sha256, "ascii", function(t, r) {
...
PZ.asset.cubelut = class {
    constructor(e) {
        ...
        this.asset.data.set(PZ.asset.cubelut, this.data))
    }
    get loading() {
        return this.data.loading
    }
    parseCubeLUT(e) {
        ...
        for (let e = 0; e < n.length; e++) {
            ...
            case "LUT_1D_SIZE":
                if (r = "1D",
                (i = Number(l[1])) < 2 || i > 65536)
                    return null;
                s = new Uint8Array(3 * i);
                break;
            case "LUT_3D_SIZE":
                if (r = "3D",
                (i = Number(l[1])) < 2 || i > 256)
                    return null;
    ...
    async getLUT() {
        return this.data.lut ? this.data.lut : (this.data.loading || (this.data.loading = new Promise(async(e,t)=>{
            var r = await this.readFile();
            this.data.lut = this.parseCubeLUT(r),
            e(this.data.lut)
        }
        )),
        await this.data.loading)
...
PZ.package = class {
    constructor(e, t) {
        this.data = e,
        this.baseType = t || PZ.object.getTypeString(this.data[0])
    }
    findAssetsObject(e, t) {
        if (e.children)
            for (let r = 0; r < e.children.length; r++)
                if (e.children[r]instanceof PZ.objectList)
                    this.findAssets(e.children[r], t);
                else if (e.children[r]instanceof PZ.object)
                    this.findAssetsObject(e.children[r], t);
    ...
    toJSON() {
        ...
        return this.findAssets(this.data, e.assets),
        e
    }
}
,
PZ.project = class extends PZ.object {
    ...
    static save(e, t) {
        let r = {
            version: PZ.compatibility.getCurrentVersion()
        }
    ...
    toJSON() {
        return {
            assets: this.assets,
            media: this.media.filter(e=>!e.preset),
            sequence: this.sequence
        }
    }
    load(e, t) {
        e = e || {},
        this.assets.loadAll(e.assets, t);
        for (let t = 0; t < e.media.length; t++) {
            let r = new PZ.media;
            r.loading = r.load(e.media[t]),
            this.media.push(r)
        }
...
PZ.assetList = function() {
    this.list = {},
    this.onAssetCreated = new PZ.observable,
    this.onAssetRemoved = new PZ.observable
}
,
...
PZ.assetList.prototype.load = function(e, t) {
    let r;
    return e instanceof PZ.asset ? r = e : "string" == typeof e && ((r = this.list[e]) || (r = new PZ.asset,
    e.startsWith("/") ? (r.url = e,
    r.source = PZ.asset.source.PRESET,
    r.external = !0) : (r.sha256 = e,
    r.source = PZ.asset.source.FILE),
    this.list[e] = r,
    this.onAssetCreated.update(r))),
    r ? (t ? r.mediaReferences++ : r.references++,
    r) : null
}
,
PZ.assetList.prototype.unload = function(e, t) {
    e instanceof PZ.asset || (e = e.asset),
    t ? e.mediaReferences-- : e.references--,
    this.removeIfUnused(e)
}
,
...
PZ.assetList.prototype.removeIfUnused = function(e) {
    e.references <= 0 && e.mediaReferences <= 0 && (e.source === PZ.asset.source.FILE && e.url && URL.revokeObjectURL(e.url),
...
PZ.assetList.prototype.restore = function(e) {
    this.list[e.key] = e,
    this.onAssetCreated.update(e)
}
,
PZ.assetList.prototype.loadAll = function(e, t) {
    for (var r = Object.keys(e), i = 0; i < r.length; i++) {
        var a = e[r[i]];
        this.list[r[i]] = new PZ.asset,
        this.list[r[i]].load(a, t),
        this.onAssetCreated.update(this.list[r[i]])
    }
}
,
PZ.assetList.prototype.saveAll = function(e) {
    for (var t = Object.keys(this.list), r = 0; r < t.length; r++)
        this.list[t[r]].save(e)
}
,
PZ.sequence = class extends PZ.object {
    ...
    load(e) {
        if (this.properties.load(e && e.properties),
        e) {
            this.length = e.length;
            for (let t = 0; t < e.videoTracks.length; t++) {
                let r = new PZ.track.video;
                this.videoTracks.push(r),
                r.load(e.videoTracks[t])
            }
            for (let t = 0; t < e.audioTracks.length; t++) {
                let r = new PZ.track.audio;
                this.audioTracks.push(r),
                r.load(e.audioTracks[t])
            }
    ...
    update(e) {
        for (let t = 0; t < this.videoTracks.length; t++)
            this.videoTracks[t].update(e)
    }
    async prepare(e, t) {
        this.update(e);
        for (let r = 0; r < this.videoSchedules.length; r++)
            await this.videoSchedules[r].prepare(e, t)
    }
}
,
    ...
    t) {
        ...
        for (let i = 0; i < r.length; i++) {
            ...
            for (let t = 0; t < s.length; t++)
                a.clips[t] = e.parent.addressLookup(s[t]),
                a.clips[t].link = a
        }
    }
}
...
PZ.clipLinks.prototype.link = function(e, t) {
    return this.links[e] || (this.links[e] = new PZ.clipLink(e)),
    this.links[e].clips.push(t),
    this.links[e]
}
,
...
PZ.clipLink.prototype.toJSON = function(e) {
    ...
    for (var t = {
        clips: []
    }, r = 0; r < this.clips.length; r++)
        t.clips.push(this.clips[r].getAddress());
    return t
}
,
...
PZ.track.audio = class extends PZ.track {
    constructor() {
        super(),
        this.clips = new PZ.objectList(this,PZ.clip.audio),
...
PZ.clip = class extends PZ.object {
    ...
    get mediaLength() {
        ...
        return this.media && (e = this.media.length * this.parentProject.sequence.properties.rate.get()),
        e
    }
    load(e) {
        this.start = e.start,
    ...
    unload() {
        this.media && this.parentProject.assets.unload(this.media),
        this.object && this.object.unload()
    }
    update(e) {
...
PZ.clip.audio = class extends PZ.clip {
    constructor(e) {
        super(),
        this.properties.time.hideAnimateToggle = !0,
        this.object = new PZ.audio,
        this.object.parent = this,
        this.children.push(this.object)
    }
    load(e) {
        e && (PZ.clip.prototype.load.call(this, e),
        this.object.load(e.object))
    }
}
,
...
PZ.layer = class extends PZ.object {
    static create(e) {
        let t, r = [PZ.layer.texture, PZ.layer.adjustment, PZ.layer.composite, PZ.layer.image, PZ.layer.scene, PZ.layer, PZ.layer.shape, PZ.layer.shape.text, PZ.layer.shape.preset];
        if ("number" == typeof e) {
            t = new (0,
            r[e])
        } else
    ...
    load(e) {
        ...
        this.fragShader = this.parentProject.assets.createFromPreset(PZ.asset.type.SHADER, "/assets/shaders/fragment/blend.glsl"),
        ...
        if (this.loadShaders = Promise.all([this.vertShader.getShader(), this.fragShader.getShader()]),
        this.loadShaders.then(function(e) {
            t.vertexShader = e[0],
            t.fragmentShader = e[1],
            t.needsUpdate = !0
        }),
    ...
    update(e) {
        ...
        for (var a = 0; a < this.effects.length; a++)
            this.effects[a].update(e)
    }
    async prepare(e, t) {
        await this.loadShaders;
        for (var r = 0; r < this.effects.length; r++)
            await this.effects[r].loading,
            await this.effects[r].prepare(e, t)
    }
}
,
PZ.layer.blendModes = [{
    ...
    name: "src atop",
    value: "BLEND_SRC_ATOP"
}, {
    name: "dest atop",
    value: "BLEND_DST_ATOP"
}, {
    name: "xor",
    value: "BLEND_XOR"
}, {
    ...
    name: "invert rgb",
    value: "BLEND_INVERT_RGB"
}, {
    name: "linear dodge",
    value: "BLEND_LINEARDODGE"
}, {
    name: "linear burn",
    value: "BLEND_LINEARBURN"
}, {
    name: "vivid light",
    ...
    name: "saturation",
    value: "BLEND_SATURATION"
}, {
    name: "color",
    value: "BLEND_COLOR"
}, {
    name: "luminosity",
    value: "BLEND_LUMINOSITY"
}, {
    name: "add",
    value: "BLEND_PLUS"
}, {
    name: "add darker",
    value: "BLEND_PLUS_DARKER"
}, {
    name: "subtract",
    value: "BLEND_MINUS"
}, {
    name: "contrast",
    value: "BLEND_CONTRAST"
}, {
    name: "invert ovg",
    value: "BLEND_INVERT_OVG"
}, {
    name: "red",
    value: "BLEND_RED"
}, {
...
PZ.layer.propertyDefinitions = {
    ...
    blending: {
        ...
        changed: function() {
            ...
            e.composite.quad.material.needsUpdate = !0
        }
    }
},
...
PZ.layer.composite = class extends PZ.layer {
    constructor() {
        super(),
        this.objects = new PZ.objectList(this,PZ.layer),
    ...
    load(e) {
        ...
        this.properties.resolution.set([t[0], t[1]]);
        let r = this.properties.resolution.get();
        if (this.composite.quad.scale.set(r[0], r[1], 1),
        "object" == typeof e)
            for (let t = 0; t < e.objects.length; t++) {
    ...
    async prepare(e, t) {
        for (let r = 0; r < this.objects.length; r++)
            await this.objects[r].prepare(e, t);
...
PZ.layer.image = class extends PZ.layer {
    ...
    load(e) {
        ...
        e) {
            ...
            e && (this.image = new PZ.asset.image(e),
    ...
    async prepare(e, t) {
        this.image && await this.image.loading,
        await super.prepare(e, t)
    }
    unload() {
        this.image && (this.parentProject.assets.unload(this.image),
...
PZ.layer.shape = class extends PZ.layer {
    ...
    load(e) {
        ...
        let r = this.properties.resolution.get();
        this.composite.quad.scale.set(r[0], r[1], 1),
        this.properties.position.visible = !1,
        this.properties.scale.visible = !1,
        this.properties.rotation.visible = !1
    }
    unload() {
    ...
    draw(e) {
        ...
        e.translate(.5 * e.canvas.width, .5 * e.canvas.height);
        let t = this.properties.resolution.get();
        e.scale(e.canvas.width / t[0], e.canvas.height / t[1]);
        for (let t = 0; t < this.objects.length; t++)
            this.objects[t].draw(this.frame, e);
        e.restore()
    }
}
,
...
PZ.layer.shape.preset = class extends PZ.layer.shape {
    constructor() {
        super(),
        this.shapesNeedUpdate = !0,
        this.objects.visible = !1
    }
    load(e) {
        if (super.load(e),
        !this.objects.length) {
    ...
    update(e) {
        this.shapesNeedUpdate && (this.updateShapes(),
        this.shapesNeedUpdate = !1),
        super.update(e)
    }
    toJSON() {
        let e = super.toJSON();
        return e.objects = [PZ.shape.prototype.toJSON.call(this.objects[0])],
        e
    }
    updateShapes() {
        ...
        switch (e.path = {},
        this.shapeProperties.preset.get()) {
        case 0:
            e.path.draw = function(e) {
                e.beginPath(),
                e.ellipse(0, 0, 100, 100, 0, 0, 2 * Math.PI)
            }
            ;
            break;
        case 1:
...
PZ.layer.shape.text = class extends PZ.layer.shape {
    ...
    unload() {
        this.font && this.parentProject.assets.unload(this.font),
        super.unload()
    }
    update(e) {
        this.fontNeedsUpdate && (this.updateFont(),
        this.fontNeedsUpdate = !1),
        this.shapesNeedUpdate && (this.updateShapes(),
        this.shapesNeedUpdate = !1),
        super.update(e)
    }
    ...
    updateShapes() {
        ...
        for (let e = 0; e < i.length; e++) {
            ...
            let n = i[e]
              , o = n.xMax - n.xMin
              , u = n.yMax - n.yMin;
            Number.isNaN(u) || (p = Math.min(p, a + n.xMin * t),
        ...
        for (a = -(.5 * (n = l - p) + p),
        s = -(.5 * (o = c - h) + h); this.objects[0].objects.length; )
            this.objects[0].objects.splice(this.objects[0].objects.length - 1, 1);
    ...
    async prepare(e, t) {
        this.font && await this.font.loading,
        await super.prepare(e, t)
    }
}
,
PZ.layer.shape.text.propertyDefinitions = {
    ...
    font: {
        ...
        changed: function() {
            let e = this.parentObject;
            e.font && (e.parentProject.assets.unload(e.font),
            e.font = null),
            this.value && (e.font = new PZ.asset.font(e.parentProject.assets.load(this.value)),
            e.fontNeedsUpdate = !0)
        }
    },
    size: {
...
PZ.media = class extends PZ.object {
    ...
    async load(e) {
        ...
        for (let t = 0; t < e.assets.length; t++)
            this.assets[t] = this.parentProject.assets.load(e.assets[t], !0);
        this.loaded = !0
    }
    unload() {
        for (let e = 0; e < this.assets.length; e++)
            this.parentProject.assets.unload(this.assets[e], !0)
    }
    toJSON() {
        return {
            properties: this.properties,
...
PZ.effect = class extends PZ.object {
    static create(e) {
        let t, r = [PZ.effect.group, PZ.effect.shader];
        if ("number" == typeof e) {
            t = new (0,
            r[e])
        } else
    ...
    async load(e) {
        ...
        this.onParentChanged.watch(this.parentChanged.bind(this), !0)
    }
    update() {}
    resize() {}
    unload() {}
...
PZ.effect.shader = class extends PZ.effect {
    ...
    propertyRemoved(e) {
        if (e.properties.name.onChanged.unwatch(this.updateFn),
        e instanceof PZ.property.static)
            if (e.definition.type === PZ.property.type.ASSET) {
                const t = this.textures.get(e.get());
                t && (this.parentProject.assets.unload(t.asset),
                t.texture.dispose())
            } else
                e.onChanged.unwatch(this.updateFn);
        this.fragmentShaderNeedsUpdate = !0
    }
    static assetChanged(e) {
        ...
        if (t.textures.get(e)) {
            ...
            t.parentProject.assets.unload(r.asset),
            r.texture.dispose(),
            t.textures.delete(e)
        }
        if (this.value) {
            ...
            e.texture = e.asset.getTexture(!0),
    ...
    async load(e) {
        if (this.properties.load(e && e.properties),
        "object" == typeof e && e.customProperties)
            for (let t = 0; t < e.customProperties.length; t++) {
                let r = PZ.property.create(e.customProperties[t].type);
                this.customProperties.push(r),
                r.load(e.customProperties[t])
    ...
    unload() {
        for (let e of this.textures.keys()) {
            ...
            this.parentProject.assets.unload(t.asset),
            t.texture.dispose()
        }
    }
    resize() {
    ...
    update(e) {
        if (this.fragmentShaderNeedsUpdate)
            ...
            this.fragmentShaderNeedsUpdate = !1,
            this.fragmentShaderHasError = !1;
        ...
        for (var t = 0; t < this.customProperties.length; t++) {
            if (this.customProperties[t]instanceof PZ.property.dynamic == !1)
                continue;
...
PZ.material = class extends PZ.object {
    ...
    parentChanged(e) {
        this.threeObj && (e && (e.parent.threeObj.material = this.oldMaterial),
        this.parent && (this.oldMaterial = this.parentObject.threeObj.material,
    ...
    async load(e) {
        ...
        (await PZ.material.fnList[this.type]).call(this),
        this.load(e),
...
PZ.object3d = class extends PZ.object {
    static create(e) {
        let t, r = [PZ.object3d.shape, PZ.object3d.text, PZ.object3d.model, PZ.object3d.light, PZ.object3d.particles, PZ.object3d.group, PZ.object3d.camera];
        if ("number" == typeof e) {
            let i = r[e];
            i || 99 !== e || (i = PZ.object3d.dummy),
            t = new i
        } else
            t = new PZ.object3d;
        return t.type = e,
    ...
    parentChanged() {
        ...
        this.parent && (this.parentObject.threeObj.add(this.threeObj),
        this.parentObject instanceof PZ.object3d.group && !(this instanceof PZ.object3d.group) && (this.threeObj.layers.mask = this.parentObject.threeObj.layers.mask)))
    }
    async load(e) {
        ...
        (await PZ.object3d.fnList[this.type]).call(this),
        this.load(e)
    }
    toJSON() {}
    update() {}
...
PZ.object3d.light = class extends PZ.object3d {
    ...
    update(e) {
        let t;
        this.properties.position && (t = this.properties.position.get(e),
        this.threeObj.position.set(t[0], t[1], t[2])),
        this.properties.target && (t = this.properties.target.get(e),
        ...
        this.properties.groundColor && (t = this.properties.groundColor.get(e),
        this.threeObj.groundColor.setRGB(t[0], t[1], t[2])),
    ...
    changeObjectType(e) {
        ...
        this.objectType < 4 && (this.threeObj.castShadow = !0,
...
PZ.object3d.model = class extends PZ.object3d {
    ...
    load(e) {
        switch ("object" == typeof e && (this.objectType = e.objectType),
        this.objectType) {
        case 2:
    ...
    unload() {
        for (var e = 0; e < this.textures.length; e++)
            this.parentProject.assets.unload(this.textures[e])
    }
    update(e) {
        let t;
        ...
        this.lidobj && this.lidobj.rotation.set(.032 * this.properties.modelProperties.lidrotation.get(e), 0, 0)
    }
    changeObjectType(e) {
        let t = "Model";
        switch (this.objectType = e,
    ...
    loadTexture(e) {
        ...
        return t = new PZ.asset.image(this.parentProject.assets.load(t)),
...
PZ.object3d.particles = class extends PZ.object3d {
    constructor() {
        super(),
        this.texture = null,
        this.properties.addAll(PZ.object3d.particles.propertyDefinitions)
    }
    get presetTextures() {
        return ["artsy", "bar_blur", "circle_sft2", "circle_soft", "circle_soft3", "circle_soft4", "clumpy_blurry", "dots", "flash1", "flash2", "flash3", "misc", "nebula", "plume", "plume2", "plume3", "plume4", "ring", "ring_blur", "ring_partial", "skull", "smokey", "splash", "splotch1", "splotch2", "spots", "squae_soft_blob", "square_soft", "squiggles", "star1", "star2", "star3", "tentacles", "tribal", "twisted", "waterfall"]
    }
    get vertexShader() {
        return ["uniform vec2 resolution;", "uniform float time;", "uniform float rate;", "uniform float lifetime;", "uniform vec3 accel;", "uniform float vdist;", "uniform vec3 ivel_box;", "uniform vec3 vspread_box;", "uniform float ivel_sphere;", "uniform float vspread_sphere;", "uniform float pdist;", "uniform vec3 ipos;", "uniform vec3 pspread_box;", "uniform vec3 pspread_sphere;", "uniform float iang;", "uniform float aspread;", "uniform float angvel;", "uniform float avspread;", "uniform sampler2D color;", "uniform sampler2D size;", "attribute float pid;", "varying vec4 vColor;", "varying float vAngle;", "float rand(vec2 n) { ", "return fract(sin(dot(n, vec2(12.9898, 4.1414))) * 43758.5453);", "}", "void main()", "{", "float delay = pid / rate;", "float ptime = mod(time - delay, lifetime);", "float count = floor((time - delay) / lifetime) + 1.0;", "vColor = step(delay, time) * texture2D(color, vec2(ptime / lifetime, 0.0));", "float scale = texture2D(size, vec2(ptime / lifetime, 0.0)).r;", "float a = iang + (-0.5 + rand(vec2(pid*count, pid)) ) * aspread;", "float avel = angvel + avspread * (rand(vec2(pid*count, 10.0)) - 0.5);", "vAngle = avel*ptime + a;", "#if PDIST==0", "vec3 p = ( vec3(-0.5) + ", "  vec3(rand(vec2(pid*count, pid*1.0)), rand(vec2(pid*count, pid*2.0)), rand(vec2(pid*count, pid*3.0))) )", "  * pspread_box;", "#else", "float phi = rand(vec2(pid*count, pid*1.0)) * 6.28319;", "float theta = rand(vec2(pid*count, pid*2.0)) * 3.14159 * pspread_sphere.z;", "float rad = (rand(vec2(pid*count, pid*3.0)) - 0.5) * pspread_sphere.y + pspread_sphere.x;", "vec3 p = rad * vec3(sin(phi)*cos(theta), sin(phi)*sin(theta), cos(phi));", "#endif", "#if VDIST==0", "vec3 v = ivel_box + ( vec3(-0.5) + ", "  vec3(rand(vec2(pid*count, pid*3.0)), rand(vec2(pid*count, pid*2.0)), rand(vec2(pid*count, pid*1.0))) )", "  * vspread_box;", "#else", "vec3 v = (ivel_sphere + (rand(vec2(pid*count, pid*3.0)) - 0.5) * vspread_sphere) * normalize(p);", "#endif", "vec3 pos = accel*ptime*ptime*0.5 + v*ptime + p + ipos;", "vec4 mvPosition = modelViewMatrix * vec4(pos, 1.0 );", "gl_PointSize = scale * resolution.x * 50.0 / length( mvPosition.xyz );", "gl_Position = projectionMatrix * mvPosition;", "}"].join("\n")
    }
    get fragmentShader() {
        return ["uniform sampler2D image;", "varying vec4 vColor;", "varying float vAngle;", "void main()", "{", "float x = gl_PointCoord.x - 0.5;", "float y = 1.0 - gl_PointCoord.y - 0.5;", "float c = cos(-vAngle);", "float s = sin(-vAngle);", "vec2 rotatedUV = vec2(c * x + s * y + 0.5, c * y - s * x + 0.5);", "vec4 tcolor = texture2D( image,  rotatedUV );", "gl_FragColor = tcolor * vColor;", "}"].join("\n")
    }
    redrawGradient(e, t) {
        if (0 !== t.length) {
            t.sort(function(e, t) {
        ...
        function a(e) {
            ...
            return r.r = parseInt(t[0]),
            r.g = parseInt(t[1]),
            r.b = parseInt(t[2]),
            r.a = void 0 !== t[3] ? parseFloat(t[3]) : 1,
            r
        }
        function s(e, i) {
            ...
            "string" == typeof (n = {
                position: p.position,
                color: p.color
            }).color && (n.color = a(n.color)),
            s && ("string" == typeof (o = {
                position: s.position,
                color: s.color
            }).color && (o.color = a(o.color)),
            function(e, t, r) {
                function i(e, t, r) {
                    return (t - e) * r + e
                }
    ...
    randomize() {
        ...
        e.rate.set(Math.round(PZ.random.number(.1, 3) * e.number.get())),
        PZ.random.number(0, 1) > .5 ? e.lifetime.set(e.number.get() / e.rate.get()) : e.lifetime.set(PZ.random.normal(r, .5 * r));
        let p = 0;
        PZ.random.number(0, 1) > .3 && (p = e.number.get() / e.rate.get());
        let l = {
            animated: !0,
            keyframes: [{
                frame: 0,
                ...
                frame: t - 1,
                value: p + r * PZ.random.number(.1, 3),
                tween: PZ.random.number(0, 1) > .9 ? PZ.random.number(2, 31, !0) : 1
            }]
        };
        e.time.load(l),
        e.pdist.set(PZ.random.number(0, 2, !0));
        var h = 500 * PZ.random.number(0, 2, !0);
        0 === e.pdist.get() ? e.pspread.set([PZ.random.normal(h, 300), PZ.random.normal(h, 300), PZ.random.normal(h, 300)]) : (e.iradius.set(PZ.random.normal(h, 300)),
        e.rspread.set(PZ.random.number(1, 2 * e.iradius.get()))),
        e.vdist.set(PZ.random.number(0, 1, !0)),
        0 === e.vdist.get() ? (e.ivel.set([PZ.random.normal(0, 100), PZ.random.normal(0, 100), PZ.random.normal(0, 100)]),
        e.vspread.set([Math.abs(PZ.random.normal(0, 100)), Math.abs(PZ.random.normal(0, 100)), Math.abs(PZ.random.normal(0, 100))])) : (e.irvel.set(PZ.random.normal(100, 200)),
        e.rvspread.set(Math.abs(PZ.random.normal(0, 100)))),
        ...
        PZ.random.number(0, 1) > .2 ? e.aspread.set(PZ.random.number(0, 359)) : e.aspread.set(0),
        PZ.random.number(0, 1) > .4 ? (e.angvel.set(PZ.random.normal(0, 20)),
        e.avspread.set(Math.abs(PZ.random.normal(0, 200)))) : (e.angvel.set(0),
        e.avspread.set(0)),
    ...
    updateProps() {
        let e, t = this.material.uniforms, r = this.properties;
        ...
        r.pdist.get() > 0 ? (t.pspread_sphere.value.x = r.iradius.get(),
        t.pspread_sphere.value.y = r.rspread.get(),
        t.pspread_sphere.value.z = 1 === r.pdist.get() ? 1 : 0) : (e = r.pspread.get(),
        t.pspread_box.value.set(e[0], e[1], e[2])),
        this.material.defines.VDIST = r.vdist.get(),
        r.vdist.get() > 0 ? (t.ivel_sphere.value = r.irvel.get(),
        t.vspread_sphere.value = r.rvspread.get()) : (e = r.ivel.get(),
    ...
    unload() {
        ...
        this.texture && (this.parentProject.assets.unload(this.texture),
        this.material.uniforms.image.value.dispose())
    }
    update(e) {
...
PZ.object3d.particles.propertyDefinitions = {
    ...
    color: {
        ...
        changed: function() {
            ...
            e.material.uniforms.color.value.needsUpdate = !0
        }
    },
    size: {
        name: "Size",
        ...
        changed: function(e) {
            let t = this.parentObject;
            t.redrawGradient(t.sizeTex.image.data, this.value),
            t.material.uniforms.size.value.needsUpdate = !0
        }
    },
    number: {
    ...
    vdist: {
        ...
        changed: function() {
            let e = this.parentObject;
            e.material.defines.VDIST = this.value,
            e.material.needsUpdate = !0
        }
    },
    ivel: {
    ...
    texture: {
        ...
        changed: function() {
            let e = this.parentObject;
            if (e.texture && (e.parentProject.assets.unload(e.texture),
            e.texture = null,
...
PZ.object3d.shape = class extends PZ.object3d {
    ...
    unload() {
        this.customGeometry && (this.parentProject.assets.unload(this.customGeometry),
        this.threeObj.geometry.dispose()),
        this.material && this.material.unload()
    }
    update(e) {
        let t;
        this.geometryNeedsUpdate && (this.generatePresetGeometry(),
        this.geometryNeedsUpdate = !1),
        t = this.properties.position.get(e),
        this.threeObj.position.set(t[0], t[1], t[2]),
        t = this.properties.rotation.get(e),
        this.threeObj.rotation.set(t[0], t[1], t[2]),
    ...
    async prepare(e) {
        ...
        this.material && (await this.material.loading,
        await this.material.prepare(e))
    }
    updateGeometry(e) {
        this.threeObj && (this.threeObj.geometry && (this.threeObj.geometry.dispose(),
        this.threeObj.geometry = null),
        e && (this.threeObj.geometry = e,
        this.threeObj.geometry.buffersNeedUpdate = !0))
    }
    generatePresetGeometry() {
        ...
        let e, t = this.properties.geometryProperties;
        switch (this.objectType) {
        case 1:
            e = new THREE.BoxGeometry(t.box_size.get()[0],t.box_size.get()[1],t.box_size.get()[2]);
            break;
        case 2:
            e = new THREE.CylinderGeometry(t.cylinder_size.get()[0],t.cylinder_size.get()[1],t.cylinder_size.get()[2],t.cylinder_detail.get(),1,!t.cylinder_openEnded.get());
            break;
        case 3:
        ...
        case 4:
            ...
            break;
        case 5:
            e = new THREE.SphereGeometry(t.sphere_size.get(),t.sphere_detail.get()[0],t.sphere_detail.get()[1],0,2 * Math.PI,0,Math.PI);
            break;
        case 6:
            e = new THREE.TorusGeometry(t.donut_size.get()[0],t.donut_size.get()[1],t.donut_detail.get()[0],t.donut_detail.get()[1],2 * Math.PI);
            break;
        case 7:
            let i = [];
            for (let e = 0; e < t.path_loops.get() * t.path_detail.get()[1]; e++)
                i.push(new THREE.Vector3(t.path_size.get()[0] * Math.cos(2 * Math.PI * e / t.path_detail.get()[1]),t.path_size.get()[1] * Math.sin(2 * Math.PI * e / t.path_detail.get()[1]),t.path_size.get()[2] * e / t.path_detail.get()[1]));
            let a = new THREE.CatmullRomCurve3(i)
              , s = {
                steps: 10 * t.path_detail.get()[1],
                bevelEnabled: !1,
                extrudePath: a
            }
              , n = []
            ...
            (e = new THREE.ExtrudeGeometry(p,s)).computeFaceNormals(),
    ...
    createMesh() {
        ...
        case 2:
            ...
            this.properties.geometryProperties.addAll({
                ...
                cylinder_openEnded: PZ.property.create(PZ.object3d.shape.propertyDefinitions.cylinder_openEnded)
            });
            break;
        case 3:
            e = "Rectangle",
...
PZ.object3d.shape.propertyDefinitions = {
    ...
    customGeometry: {
        ...
        changed: function() {
            ...
            this.value && (e.customGeometry = new PZ.asset.geometry(e.parentProject.assets.load(this.value)),
...
PZ.object3d.text = class extends PZ.object3d {
    ...
    updateGeometry() {
        let e = this.font;
        e && e.font3d && (this.threeObj.geometry.dispose(),
    ...
    updateFont() {
        let e = this.font;
        e && e.get3DFont().then(t=>{
            this.font === e && (this.geometryNeedsUpdate = !0)
        }
        )
    }
    load(e) {
        if (this.threeObj = new THREE.Mesh(new THREE.Geometry,new THREE.Material),
        this.threeObj.material.visible = !1,
        this.properties.load(e && e.properties),
        "object" == typeof e && e.material) {
            let t = PZ.material.create(e.material.type);
    ...
    update(e) {
        ...
        this.fontNeedsUpdate && (this.updateFont(),
        this.fontNeedsUpdate = !1),
        this.geometryNeedsUpdate && (this.updateGeometry(),
        this.geometryNeedsUpdate = !1),
        t = this.properties.position.get(e),
        this.threeObj.position.set(t[0], t[1], t[2]),
        t = this.properties.rotation.get(e),
    ...
    center() {
        ...
        t.multiplyScalar(-.5),
        this.properties.positionMode.get()) {
        case 1:
            t.x -= t.x;
            break;
        case 2:
...
PZ.object3d.group = class extends PZ.object3d {
    ...
    load(e) {
        ...
        "object" == typeof e) {
            ...
            if (this.threeObj.layers.mask = 0,
    ...
    reflectionVisibility: {
        ...
        changed: function() {
            ...
            for (var t = 0; t < e.objects.length; t++)
                e.objects[t]instanceof PZ.object3d.group == !1 && (e.objects[t].threeObj.layers.mask = e.threeObj.layers.mask)
        },
...
PZ.object3d.camera = class extends PZ.object3d {
    ...
    changeObjectType(e) {
        ...
        case 1:
            ...
            this.threeObj = new THREE.PerspectiveCamera(60,1,.1,5e3);
            break;
        case 2:
            t = "Orthographic Camera",
            this.threeObj = new THREE.OrthographicCamera(-.05,.05,.05,-.05,.1,5e3)
        }
        this.properties.name.set(t),
        this.parentChanged(),
        this.parentLayer.pass.camera = this.threeObj,
        this.parentLayer.properties.resolution.onChanged.watch(this.resolutionChanged.bind(this), !0)
    }
    resolutionChanged() {
        ...
        if (1 === this.objectType) {
            ...
            this.threeObj.left = -.05 * t,
            this.threeObj.right = .05 * t,
            this.threeObj.top = .05 * r,
            this.threeObj.bottom = -.05 * r;
...
PZ.shape.group = class extends PZ.shape {
    ...
    draw(e, t) {
        t.save();
        let r = this.properties.rotation.get(e)
          , i = this.properties.position.get(e)
          , a = this.properties.scale.get(e)
          , s = Math.cos(r)
          , n = Math.sin(r);
        t.transform(a[0] * s, -a[0] * n, a[1] * n, a[1] * s, -a[0] * s * .5 - a[1] * n * .5 + i[0] + .5, a[0] * n * .5 - a[1] * s * .5 - i[1] + .5);
        for (let r = 0; r < this.objects.length; r++) {
...
PZ.shape.path = class extends PZ.shape {
    ...
    draw(e, t, r) {
        ...
        let i = this.properties.position.get(e)
          ...
          , n = Math.cos(a)
          , o = Math.sin(a);
        t.transform(s[0] * n, -s[0] * o, s[1] * o, s[1] * n, -s[0] * n * .5 - s[1] * o * .5 + i[0] + .5, s[0] * o * .5 - s[1] * n * .5 - i[1] + .5),
        this.path.draw(t);
        for (let r = 0; r < this.operations.length; r++)
            this.operations[r].draw(e, t);
        t.restore()
...
PZ.draw.fill = class extends PZ.draw {
    ...
    toJSON() {
        let e = super.toJSON();
        return e.properties = this.properties,
        e
    }
    draw(e, t) {
        let r;
        r = this.properties.color.get(e),
        t.fillStyle = "rgb(" + Math.floor(255 * r[0]) + ", " + Math.floor(255 * r[1]) + ", " + Math.floor(255 * r[2]) + ")",
        t.fill()
    }
}
,
...
PZ.draw.stroke = class extends PZ.draw {
    ...
    draw(e, t) {
        let r;
        r = this.properties.color.get(e),
        t.strokeStyle = "rgba(" + Math.floor(255 * r[0]) + ", " + Math.floor(255 * r[1]) + ", " + Math.floor(255 * r[2]) + ", " + this.properties.opacity.get(e) + ")",
